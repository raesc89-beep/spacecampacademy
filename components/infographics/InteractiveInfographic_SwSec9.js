...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      "El traje emblemático, oscuro e intimidante de Darth Vader es, en su núcleo más fundamental, una cámara de reanimación médica andante y una unidad de cuidados intensivos miniaturizada. Tras sufrir quemaduras volcánicas catastróficas y letales que destruyeron irreversiblemente casi la totalidad de su piel. Sus pulmones en las ardientes orillas de lava del planeta Mustafar, Anakin Skywalker dependía al cien por ciento de su gruesa armadura de obsidiana presurizada. Este traje sellado de manera hermética servía simultáneamente como una barrera estéril contra infecciones masivas mortales y como un sistema de ventilación pulmonar mecánico ininterrumpido.",
      "En el mundo real de la ciencia aerospacial, el ejemplo supremo y más cercano a esta tecnología es el asombroso traje espacial para Actividades Extravehiculares (Traje EVA). Utilizan los astronautas altamente entrenados de la NASA en la Estación Espacial Internacional. Estos voluminosos e increíbles trajes blancos no son simples ropas; son esencialmente verdaderas naves espaciales con forma humana en miniatura. Contienen sofisticados subsistemas de enfriamiento por agua líquida que recorren cientos de metros de tuberías para evitar. El cuerpo del astronauta hierva bajo el intenso sol espacial, y sistemas químicos de depuración molecular que filtran continuamente el aire tóxico exhalado.",
      "La pesada y parpadeante placa de control computarizada que Darth Vader lleva anclada firmemente en el centro de su pecho no es un simple panel decorativo; es el ordenador médico central. El corazón tecnológico del traje, monitoreando constantemente docenas de variables biométricas críticas en tiempo real. En la Tierra contemporánea, los hospitales más modernos del mundo utilizan monitores de pacientes digitales de última generación que desempeñan funciones idénticas y rigurosas. Estos aparatos computarizados rastrean y analizan el ritmo cardíaco, la saturación porcentual de oxígeno en la sangre y la presión arterial continua, activando alarmas estridentes de manera inmediata si los signos vitales del paciente se desploman repentinamente.",
      "A medida que la ambiciosa exploración espacial humana se expande rápidamente con miras hacia las futuras colonizaciones habitables de la Luna. De las áridas llanuras rojas de Marte, la ingeniería de trajes de soporte vital portátiles y ligeros avanza a un ritmo frenético. Los ingenieros bioespaciales contemporáneos están desarrollando activamente impresionantes bio-trajes elásticos inteligentes que logran aplicar presión mecánica directa sobre la piel de los astronautas (en lugar de utilizar sistemas inflables gigantescos. Torpes), garantizando una movilidad anatómica sin precedentes y una protección térmica total en los brutales e inhóspitos desiertos alienígenas y vacíos espaciales extremos."
    ],
    expandables: [
      { 
        label: 'En la Película', 
        icon: 'zap', 
        text: 'En la culminante y desoladora secuencia final del Episodio III: La Venganza de los Sith, presenciamos el agónico y dramático momento en. Los droides quirúrgicos de emergencia instalan desesperadamente el doloroso traje de soporte vital en el cuerpo masivamente quemado de Anakin Skywalker. La pesada e imponente máscara respiratoria es descendida lentamente sobre su rostro y sellada herméticamente, momento en el cual escuchamos por primera vez el escalofriante. Rítmico sonido mecánico de su respiración artificial, simbolizando la completa y absoluta transición del hombre hacia la dependencia total e irreversible de una fría máquina médica.' 
      },
      { 
        label: 'Dato Científico', 
        icon: 'atom', 
        text: 'El complejo e inmenso Sistema de Soporte Vital y Control Ambiental (ECLSS, por sus siglas en inglés) utilizado permanentemente a bordo de la Estación Espacial Internacional moderna recicla casi el 93% de todos los líquidos corporales humanos, procesando rigurosamente incluso la transpiración ambiental. La orina humana hasta transformarla nuevamente en agua potable purificada que es estadísticamente más limpia y segura para el consumo humano que el agua promedio embotellada de la llave en la Tierra. Este nivel de purificación circular continua es tecnológicamente imperativo e indispensable para poder sobrevivir durante años en las inhóspitas condiciones del espacio profundo exterior.' 
      },
      { 
        label: '¿Sabías que...?', 
        icon: 'sparkles', 
        text: 'Los impresionantes trajes espaciales de modelo EVA contemporáneos de la NASA son pesados y voluminosos; pesan asombrosamente alrededor de 127 kilogramos completos (casi 280 libras enteras) mientras se encuentran en la Tierra bajo gravedad normal. Sin embargo, en la ingravidez total del micro-espacio exterior, los astronautas experimentados se sienten ligeros y no notan en absoluto este peso masivo. De igual manera, se presume lógicamente que la pesada y blindada armadura de Darth Vader era fatigante para sus músculos y esqueleto destrozado, obligándolo a utilizar la Fuerza oscura constantemente solo para poder caminar.' 
      }
    ],
  ...
  },
  {
    ...
    content: [
      ...
      "El traje de Darth Vader funciona como un exoesqueleto médico. Debido al daño irreversible que sufrió en su columna y músculos por las quemaduras en Mustafar, el cuerpo de Anakin Skywalker era débil para sostenerse. Su armadura incluye servomotores y pistones que realizan el trabajo biomecánico, sustituyendo su fuerza biológica perdida.",
    ...
    fact: 'Los exoesqueletos motorizados como el sistema ReWalk, aprobado por la FDA en 2014, utilizan motores en cadera y rodilla junto con sensores de inclinación para restaurar la bipedestación. Marcha en pacientes con paraplejia espinal completa, funcionando como un equivalente médico de la armadura mecanizada de Darth Vader.'
  },
  {
    id: 'interfaz-cerebro',
  ...
  },
  {
    ...
    content: [
      ...
      "Para los pacientes con fallo pulmonar extremo, donde ni siquiera el ventilador más potente puede oxigenar la sangre adecuadamente, existe una tecnología de último recurso llamada ECMO (Oxigenación por Membrana Extracorpórea). Es literalmente un pulmón artificial externo al cuerpo. La máquina ECMO extrae sangre venosa del paciente a través de una cánula gruesa, la hace pasar por una membrana especial de polimetilpenteno donde se le agrega oxígeno. Se le retira dióxido de carbono, y luego devuelve esa sangre ya oxigenada al cuerpo. Durante la pandemia de COVID-19, la ECMO salvó la vida de miles de pacientes con neumonía severa cuyos pulmones habían dejado de funcionar casi por completo.",
  ...
  },
  {
    ...
    fact: 'La palabra cyborg fue acuñada en 1960 por Manfred Clynes y Nathan Kline en su artículo "Cyborgs and Space" para la revista Astronautics. Hoy, más de 4 millones de personas en el mundo llevan dispositivos implantados permanentemente (marcapasos, implantes cocleares, bombas de insulina, estimuladores cerebrales profundos), lo. los convierte técnicamente en organismos cibernéticos: seres donde la biología y la tecnología se fusionan para mantener o mejorar funciones vitales.'
  }
];
