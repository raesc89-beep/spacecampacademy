...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      ...
      { 
        label: '¿Sabías que...?', 
        icon: 'sparkles', 
        text: 'Los impresionantes trajes espaciales de modelo EVA contemporáneos de la NASA son extremadamente pesados y voluminosos; pesan asombrosamente alrededor de 127 kilogramos completos (casi 280 libras enteras) mientras se encuentran en la Tierra bajo gravedad normal. Sin embargo, en la ingravidez total del micro-espacio exterior, los astronautas experimentados se sienten absolutamente ligeros y no notan en absoluto este peso masivo. De igual manera, se presume lógicamente que la pesada y blindada armadura de Darth Vader era increíblemente fatigante para sus músculos y esqueleto destrozado, obligándolo a utilizar poderosamente la Fuerza oscura constantemente solo para poder caminar.' 
      }
    ],
  ...
  },
  {
    ...
    content: [
      ...
      "En nuestros florecientes laboratorios médicos contemporáneos reales, la ingeniería de asombrosos exoesqueletos para la fisioterapia de rehabilitación se ha convertido en una de las disciplinas robóticas más prometedoras, compasivas y humanas del mundo. Sistemas avanzados patentados mundialmente como ReWalk o Ekso Bionics permiten a valientes pacientes paralíticos humanos, con lesiones trágicas en la médula espinal neurológica, levantarse verticalmente y caminar paso a paso nuevamente por la sala de su casa, mediante potentes motores eléctricos computarizados localizados en las articulaciones de la cadera y en las rodillas mecánicas. A través de inteligentes y precisos sensores de inclinación inercial y complejos algoritmos de equilibrio corporal activo, estas sofisticadas armaduras cibernéticas interpretan sutilmente el cambio del centro de gravedad del usuario para dar cada paso firme automáticamente.",
      "Las grandes ramas de las fuerzas armadas militares globales y las mega-compañías industriales también han demostrado estar extremadamente interesadas en explotar estas prometedoras y novedosas tecnologías robóticas para sus aplicaciones laborales. Extraordinarios exoesqueletos logísticos de carga pesada, como el conocido y robusto HULC (Human Universal Load Carrier), han sido ingeniosamente diseñados para transferir mecánicamente todo el peso extenuante y doloroso de una mochila militar repleta de cientos de municiones mortales y gigantescas provisiones de supervivencia, directamente hacia el suelo sólido, desviando toda la terrible presión destructiva y agotadora de la columna vertebral vulnerable y de las frágiles piernas del agotado soldado operativo en el terreno salvaje.",
      "En el emocionante y dinámico futuro de la robótica biomecatrónica cercana, se espera ansiosamente que los pesados, rígidos y torpes exoesqueletos actuales den un vertiginoso salto evolutivo hacia adelante, transformándose radicalmente en ligeros e invisibles 'exo-trajes' de tejidos textiles blandos biomecánicos. Confeccionados ingeniosamente con hilos poliméricos de metales sintéticos especiales y polímeros activos inteligentes avanzados (músculos puramente artificiales reactivos al calor), estos discretos y poderosos exo-trajes elásticos y ajustados asistirán a los abuelitos de la tercera edad a caminar sin esfuerzo aparente, demostrando de esta forma maravillosa que la ingeniería biomecánica futurista no solo sirve poderosamente para construir intimidantes guerreros galácticos oscuros y siniestros, sino para ayudar enormemente a toda la humanidad a vivir mejor y sin dolor a diario."
    ],
    expandables: [
      { 
        label: 'En la Película', 
        icon: 'zap', 
        text: 'A lo largo de toda la inmensa saga galáctica, el movimiento constante de Darth Vader es intencionalmente caracterizado por su marcha muy rígida, lenta e increíblemente mecánica, que no es un simple estilo teatral de actuación o pura arrogancia del personaje siniestro. La inmovilidad casi robótica de su pesado paso se debe en realidad al hecho biológico de que la espina dorsal real y frágil de Anakin y sus cuádriceps musculares están completamente y totalmente arruinados por el magma, dependiendo absoluta y enteramente de los actuadores pesados mecatrónicos de soporte hidráulico en las piernas artificiales de su imponente exoesqueleto oscuro blindado para poder avanzar tan amenazadoramente hacia sus aterrorizados oponentes en la oscuridad.' 
      },
      { 
        label: 'Dato Científico', 
        icon: 'atom', 
        text: 'Los espectaculares y eficaces exoesqueletos médicos neuro-robóticos como el internacionalmente famoso y certificado ReWalk de Israel, logran interactuar y conectar directamente con dispositivos de monitoreo electrónico de pulso biológico para detectar ínfimos y sutiles movimientos posturales voluntarios. Un avanzado ordenador portátil a batería, discretamente escondido y colocado firmemente a modo de mochila en la espalda del paciente en rehabilitación, evalúa en fracciones de segundo la intrincada y exacta biomecánica dinámica de las marchas, suministrando al milisegundo la corriente y energía precisa a los pequeños y eficientes motores ubicados bajo las rodillas de titanio para imitar perfectamente la biomecánica suave humana.' 
      },
      { 
        label: '¿Sabías que...?', 
        icon: 'sparkles', 
        text: '¡Las asombrosas y diligentes abejas biológicas, y en realidad una inmensa mayoría abrumadora de la fascinante vida entomológica (los pequeños insectos fascinantes), de la Tierra, literalmente ya cuentan evolutivamente y visten todos los días su propia versión biológica primitiva de un espectacular exoesqueleto! En profundo y claro contraste directo con los seres humanos biológicos ordinarios, que cuentan biológicamente con un esqueleto interno de hueso (un endoesqueleto óseo), los insectos tienen todos sus tejidos de carne blanda resguardados muy adentro, estando fuertemente protegidos y sostenidos exteriormente por un rígido y resistente caparazón estructural de naturaleza quitinosa (un poderoso exoesqueleto), de la misma manera conceptual que la inmensa armadura rígida protectora del temible Señor de los Sith.' 
      }
    ],
      ...
      <div style={{ position: 'relative', zIndex: 10, padding: '3rem 2rem', maxWidth: '1200px', margin: '0 auto', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        ...
        <AnimatePresence>
          {isAllComplete && (
            ...
            >
              <img src="/assets/starwars/infographic_vader/badge_vader.png" alt="Badge" style={{ width: '40px', height: '40px', borderRadius: '50%' }} />
