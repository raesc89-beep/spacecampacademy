...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      { label: 'Secuencia Natural', icon: 'clock', text: 'La secuencia de nombres de los veinte días refleja una narrativa cronológica natural. Empieza con el agua primordial, sigue con el viento dador de vida, luego la noche que cobija la germinación y finaliza con el sol señor que ilumina. Es una crónica condensada del mito de la creación universal repetida sin pausa cíclicamente.' },
  ...
  },
  {
    ...
    content: [
      ...
      'Antes del matrimonio concertado, el calendario jugaba el rol de asesor indispensable y consultor ineludible forzoso obligatorio normativo. Los especialistas y lectores del tiempo comparaban ansiosamente y escrupulosamente los nombres de la pareja propuesta joven novios pretendientes para corroborar si sus energías internas sintonizaban o chocaban irremediablemente cataclísmicamente. Era como verificar metódicamente la compatibilidad de grupos sanguíneos biológicos médicos clínicos empíricos fácticos reales comprobables antes de una transfusión vital, buscando prevenir el caos doméstico familiar potencial destructivo.',
  ...
  },
  {
    ...
    expandables: [
      { label: 'El Origen Olmeca', icon: 'atom', text: 'Los eruditos sospechan que la matriz originaria primigenia del ciclo brotó germinó fructificó y cuajó en la región costera suriana de San Lorenzo o La Venta, de los notables escultores olmecas vetustos. Luego la exportaron culturalmente pacíficamente y pedagógicamente hacia los emergentes crecientes boyantes estados y reinos nacientes de Oaxaca, el Petén e incluso las altiplanicies volcanicas y lagos norteños centrales de México.' },
