...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      'El fenómeno es tan exacto que miles de personas se congregan cada año en Dzibilchaltún, a pesar del madrugón y el frío del amanecer, solo para ser testigos de este evento. Cuando el sol se eleva y su luz intensa se enmarca perfectamente en las puertas cuadradas, la multitud suele guardar un silencio reverencial, aplaudir o tocar instrumentos antiguos. Es una experiencia que te hace sentir pequeño y a la vez conectado con la inteligencia de los astrónomos que vivieron hace más de mil años en esas tierras.',
      'Lo más extraordinario de esta alineación es que no solo depende del edificio, sino del horizonte plano de Yucatán. Como la península no tiene grandes montañas que bloqueen la vista del sol naciente, los mayas podían observar la salida del sol en su punto más bajo y verdadero. Los arqueólogos modernos utilizan teodolitos y herramientas láser de alta tecnología para medir estas alineaciones hoy en día. Resulta increíble constatar que los cálculos de los mayas, hechos a simple vista y con herramientas rudimentarias de medición, tienen un margen de error menor a un grado.'
    ],
    expandables: [
