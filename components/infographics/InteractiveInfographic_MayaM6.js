...
// ─── SVG Decorative Elements (Maya / Dzibilchaltun themed) ────────────────────────────
...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      { label: 'Las Misteriosas Figurillas', icon: 'zap', text: 'Las siete figurillas de barro encontradas no son muñecas para jugar. Los expertos sugieren que representan a individuos con enfermedades o deformidades físicas. En la cosmovisión maya, las personas que nacían con características inusuales a menudo eran consideradas como tocadas por los dioses o con una conexión especial con el mundo espiritual. Fueron enterradas ritualmente para consagrar el espacio o pedir sanación.' },
  ...
  },
  {
    ...
    expandables: [
      { label: 'La Importancia Agrícola', icon: 'zap', text: 'En una región donde las estaciones no están marcadas por la nieve o el frío extremo, sino por los periodos de lluvia y sequía, saber exactamente en qué día del año estás es asunto de vida o muerte. Si un agricultor sembraba su maíz antes de tiempo, las semillas se secarían; si lo hacía demasiado tarde, las lluvias inundarían los brotes. El templo del equinoccio les garantizaba que su reloj agrícola no se desfasara jamás.' },
...
// ─── Maya Particle Field (Canvas Background) ──────────────────────────────
function MayaField() {
