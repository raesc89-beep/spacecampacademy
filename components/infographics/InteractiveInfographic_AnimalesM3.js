...
const INFOGRAPHIC_NODES = [
  {
    ...
    bannerImage: '/assets/animales/infographic_m3/banner_laika-preparativos.png',
    bannerCaption: 'Laika y Sputnik 2',
  ...
  },
  {
    ...
    bannerImage: '/assets/animales/infographic_m3/banner_fisiologia-entrenamiento.png',
    bannerCaption: 'Fisiología Canina',
  ...
  },
  {
    ...
    color: '#80DEEA',
    btnImage: '/assets/animales/infographic_m3/btn_belka-strelka.jpg',
    image: '/assets/animales/infographic_m3/hero_belka-strelka.jpg',
    content: [
    ...
    bannerImage: '/assets/animales/infographic_m3/banner_belka-strelka.png',
    bannerCaption: 'Belka y Strelka',
  ...
  },
  {
    ...
    color: '#3949AB',
    btnImage: '/assets/animales/infographic_m3/btn_telemetria-resultados.jpg',
    image: '/assets/animales/infographic_m3/hero_telemetria-resultados.jpg',
    content: [
    ...
    bannerImage: '/assets/animales/infographic_m3/banner_telemetria-resultados.png',
    bannerCaption: 'Telemetría y Datos',
  ...
  },
  {
    ...
    color: '#2C3E50',
    btnImage: '/assets/animales/infographic_m3/btn_legado-biologico.jpg',
    image: '/assets/animales/infographic_m3/hero_legado-biologico.jpg',
    content: [
    ...
    bannerImage: '/assets/animales/infographic_m3/banner_legado-biologico.png',
    bannerCaption: 'El Legado Espacial',
  ...
  {
    id: 'medicina-veterinaria-espacial',
    title: 'Medicina Veterinaria Espacial: Curar en la Ingravidez',
    color: '#FF8A65',
    btnImage: '/assets/animales/infographic_m3/btn_medicina-veterinaria.jpg',
    image: '/assets/course/animales_pioneros/hero_medicina_espacio.jpg',
    content: [
      'Las misiones con animales en el espacio generaron la necesidad urgente de desarrollar un campo completamente nuevo: la medicina veterinaria espacial, una especialidad que debía resolver el problema fundamentalmente inédito de cómo diagnosticar, tratar y operar animales en un entorno de microgravedad donde los fluidos corporales se comportan de manera radicalmente diferente a la prevista por cualquier texto médico terrestre. En la Tierra, el sistema cardiovascular depende de la gravedad para el retorno venoso de las extremidades inferiores hacia el corazón; en órbita, este mecanismo desaparece, generando una redistribución cefálica de fluidos que en animales pequeños con frecuencia cardíaca alta resultaba en congestión nasal severa, edema orbital y cambios en la presión intracraneal que complicaban cualquier evaluación clínica de referencia.',
      'Los perros soviéticos que regresaban del espacio requerían protocolos de rehabilitación completamente diseñados desde cero porque sus músculos posturales, atrofiados por la ingravidez, eran incapaces de soportar el peso corporal durante los primeros días de readaptación terrestre. Los veterinarios del programa soviético desarrollaron piscinas de flotación y corsés de soporte que redistribuían el peso corporal de manera gradual, permitiendo que los sistemas musculoesqueléticos se readaptaran a la gravedad sin el trauma de una carga inmediata completa. Estas técnicas de rehabilitación progresiva fueron adoptadas posteriormente, con modificaciones, en los programas de fisioterapia para astronautas humanos retornados de la estación espacial Mir, demostrando que el conocimiento generado por la medicina veterinaria espacial tiene transferencia directa a la medicina humana.',
      'Un desafío particular para la medicina veterinaria espacial fue el manejo de las condiciones de estrés psicológico crónico en animales confinados en cápsulas de dimensiones extremadamente reducidas durante períodos que a veces superaban las dos semanas. Los etólogos soviéticos documentaron comportamientos estereotipados de ansiedad en los perros confinados — movimientos repetitivos, automutilación leve, alteraciones en los patrones de sueño — que eran análogos a los trastornos de estrés postraumático observados en mamíferos terrestres sometidos a confinamiento severo. Esta documentación llevó al reconocimiento temprano de que el bienestar psicológico animal en el espacio no era un lujo ético secundario sino una variable experimental crítica: un animal con respuesta de estrés crónico activada generaba datos fisiológicos sistemáticamente sesgados que comprometían la validez científica de los experimentos biomédicos.',
      'La instrumentación médica veterinaria desarrollada para el espacio tuvo que miniaturizarse a escalas antes impensables para cumplir con las restricciones de masa y volumen de las cápsulas espaciales de la era inicial. Los primeros electrocardiógrafos orbitales veterinarios eran dispositivos implantables del tamaño de una caja de cerillas que transmitían datos cardíacos de forma continua a estaciones terrestres de recepción mediante telemetría de radio de baja potencia — tecnología que anticipó en décadas los marcapasos y monitores cardíacos implantables que hoy usan millones de pacientes humanos. De manera similar, los catéteres de presión arterial de micro-calibre desarrollados para los perros espaciales fueron los precursores directos de los micro-transductores de presión intravascular utilizados actualmente en las unidades de cuidados intensivos cardiológicos de los hospitales modernos.',
      'La medicina veterinaria espacial contemporánea se enfrenta a desafíos cualitativamente nuevos en los proyectos de misiones tripuladas a Marte que contemplan llevar animales como fuente de alimento o compañía psicológica durante travesías de 6 a 9 meses de duración. Las investigaciones actuales en la ISS con roedores en el Rodent Research módulo exploran los mecanismos de atrofia muscular acelerada, pérdida ósea y alteraciones inmunológicas en mamíferos pequeños durante estancias de 30 a 90 días, con el objetivo de desarrollar contramedidas farmacológicas y de ejercicio escalables a misiones de mayor duración. Los ratones modificados genéticamente que sobre-expresan miostatina tienen pérdida muscular significativamente menor en microgravedad, abriendo perspectivas para el desarrollo de tratamientos farmacológicos que preserven la masa muscular tanto en animales como en astronautas humanos durante los viajes interplanetarios del futuro próximo.'
    ],
    expandables: [
      { label: 'Piscinas de Rehab', icon: 'HeartPulse', text: 'Los veterinarios soviéticos inventaron piscinas de flotación para la rehabilitación de los perros espaciales; estas mismas técnicas se adoptaron después para la fisioterapia de astronautas humanos que regresaban de la Mir.' },
      { label: 'ECG Implantado', icon: 'Activity', text: 'Los primeros ECG orbitales eran implantes del tamaño de una caja de cerillas en perros espaciales — precursores directos de los marcapasos y monitores cardíacos implantables que hoy tienen millones de pacientes humanos.' }
    ],
    bannerImage: '/assets/animales/infographic_m3/banner_medicina-veterinaria-espacial.png',
    bannerCaption: 'Medicina Veterinaria Espacial: Curar en la Ingravidez',
    fact: 'Los veterinarios soviéticos descubrieron que los perros con estrés psicológico crónico producían datos fisiológicos sesgados — lo que llevó al primer protocolo formal de bienestar animal en experimentos científicos, anticipando en décadas los estándares éticos actuales.'
  },
  {
    id: 'animales-iss-actuales',
    title: 'Fauna en la ISS: Los Experimentos Vivientes del Presente',
    color: '#26A69A',
    btnImage: '/assets/animales/infographic_m3/btn_animales-iss.jpg',
    image: '/assets/course/animales_pioneros/hero_iss_animals.jpg',
    content: [
      'La Estación Espacial Internacional es hoy el zoológico orbital más sofisticado de la historia de la humanidad, albergando de forma continua o intermitente desde ratones y peces cebra hasta medusas, arañas tejedoras y tardígrados en experimentos cuidadosamente diseñados para desentrañar los mecanismos moleculares del envejecimiento, la regeneración tisular y la adaptación biológica a la microgravedad. El módulo Rodent Research, instalado por la NASA en 2014, es actualmente el sistema más avanzado de hábitat animal en órbita: una jaula climatizada, iluminada con ciclos de luz artificial que simulan el ritmo circadiano terrestre y equipada con dispensadores automáticos de comida y bebida, sensores de actividad infrarroja y cámaras de video que transmiten comportamiento animal en tiempo real a investigadores en tierra las 24 horas del día.',
      'Los experimentos con arañas tejedoras Arabella y Anita a bordo del Skylab en 1973 produjeron uno de los resultados más sorprendentes de toda la biología espacial temprana: estas arañas, cuyos comportamientos de construcción de telarañas dependen del vector gravitacional para orientar la geometría de la espiral, inicialmente tejieron redes completamente asimétricas e irregulares en microgravedad durante las primeras 24 horas. Sin embargo, en los días siguientes, sin ninguna instrucción ni intervención externa, las arañas desarrollaron espontáneamente una técnica compensatoria que producía redes geométricamente más simétricas que las construidas en tierra — un proceso de aprendizaje motor invertebrado en microgravedad que no tenía precedente documentado en ningún laboratorio terrestre y que aún hoy es objeto de estudio en el campo de la neurología del comportamiento.',
      'Las medusas enviadas a bordo del Columbia en 1991 aportaron datos fundamentales sobre el desarrollo del sistema vestibular en microgravedad que resultaron directamente aplicables a la comprensión del mareo espacial humano. Las medusas poseen estructuras sensoriales llamadas estatocistos, funcionalmente análogas a los otolitos del oído interno humano, que les permiten orientarse respecto a la vertical gravitacional en el agua marina. Los 2,478 especímenes que viajaron al espacio y los más de 60,000 que se reprodujeron durante el vuelo de 9 días mostraron que las medusas desarrolladas completamente en microgravedad eran incapaces de orientarse correctamente al ser devueltas a la gravedad terrestre, confirmando que la exposición gravitacional durante el desarrollo es una señal morfogénica esencial — un hallazgo con implicaciones directas para entender por qué los bebés nacidos prematuramente pueden tener mayor riesgo de trastornos del equilibrio.',
      'El proyecto Rodent Research en la ISS ha acumulado desde 2014 datos de más de 400 ratones en múltiples experimentos de larga duración que están transformando la comprensión de la biología del envejecimiento acelerado en microgravedad. Los ratones en órbita pierden aproximadamente el mismo porcentaje de masa ósea en 30 días que los ratones terrestres en 6 meses de envejecimiento natural, lo que hace de la microgravedad un "acelerador de envejecimiento" experimental de valor excepcional para la gerontología. Este hallazgo ha permitido identificar tres vías moleculares específicas — la señalización del TGF-β, la activación de la vía RANK-RANKL y la inhibición de la esclerostina — como los principales mediadores de la resorción ósea acelerada, abriendo el camino a intervenciones farmacológicas potenciales no solo para astronautas sino para los 200 millones de pacientes con osteoporosis en el mundo.',
      'El futuro de los experimentos biológicos en la ISS y las estaciones que la sucedan apunta hacia ecosistemas cerrados de múltiples especies donde plantas, microorganismos, invertebrados y vertebrados interactúan en ciclos biogeoquímicos que replican la funcionalidad de la biosfera terrestre a escala de laboratorio. El experimento MELiSSA (Micro-Ecological Life Support System Alternative) de la Agencia Espacial Europea ha demostrado en tierra que es posible cerrar el ciclo del carbono, nitrógeno y agua a través de cuatro compartimentos biológicos — bacterias anaeróbicas, bacterias fotosintéticas, plantas y humanos — con una eficiencia de reciclaje superior al 95%. Llevar estos ecosistemas cerrados al espacio, con animales como componentes del ciclo de proteínas, representa la siguiente frontera de la biología espacial aplicada y el fundamento biotecnológico indispensable para las colonias permanentes más allá de la Tierra que las próximas generaciones habrán de construir.'
    ],
    expandables: [
      { label: 'Arañas Adaptadas', icon: 'Sparkles', text: 'Las arañas Arabella y Anita en el Skylab desarrollaron espontáneamente una técnica de tejeduría compensatoria en microgravedad que producía redes más simétricas que en la Tierra — aprendizaje motor invertebrado sin precedente.' },
      { label: 'Medusas y Humanos', icon: 'Activity', text: 'Las medusas de la misión Columbia 1991 confirmaron que el sistema vestibular necesita gravedad durante el desarrollo: los especímenes nacidos en órbita no podían orientarse al volver a la Tierra — igual que los bebés nacidos muy prematuros.' }
    ],
    bannerImage: '/assets/animales/infographic_m3/banner_animales-iss-actuales.png',
    bannerCaption: 'Fauna en la ISS: Los Experimentos Vivientes del Presente',
    fact: 'Los ratones en la ISS pierden la misma masa ósea en 30 días que en 6 meses de envejecimiento terrestre normal, convirtiendo la microgravedad en el mejor "acelerador de envejecimiento" experimental disponible para la investigación de la osteoporosis.'
  }
