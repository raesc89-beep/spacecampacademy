...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      { label: 'En la Película', icon: 'zap', text: 'En «Arrival», la comunicación con los heptapodos usa métodos similares a los que los científicos emplean para enseñar lenguaje simbólico a grandes simios. Louise comienza con palabras simples y objetos concretos — exactamente como la investigadora Sue Savage-Rumbaugh hizo con Kanzi el bonobo usando lexigramas. La diferencia crucial es que los heptapodos no aprenden el idioma humano: Louise aprende el idioma heptapod. Esta inversión es semánticamente importante: la película establece que para comunicarse con inteligencia radicalmente diferente, el humano debe adaptarse al otro idioma, no imponer el propio.' },
    ],
  },
  {
  ...
  },
  {
    ...
    expandables: [
      { label: 'En la Película', icon: 'zap', text: 'En «Arrival», los 12 sitios de contacto distribuidos globalmente recuerdan el debate real de SETI sobre cómo responder si detectamos una señal extraterrestre. El Protocolo de SETI (1989) establece que ningún país puede responder unilateralmente — se requiere consenso internacional. La película muestra exactamente la crisis que este protocolo intenta prevenir: cada país intenta comunicarse de forma independiente, lo que lleva al caos cuando China interpreta un mensaje como una declaración de guerra. Louise propone en cambio que todos los países compartan sus traducciones — una respuesta coordinada que finalmente resuelve la crisis. La película es así un argumento poderoso para el SETI multilateral y la cooperación científica internacional.' },
    ],
  },
  {
    id: 'xenolinguistica',
    ...
    expandables: [
      { label: 'En la Película', icon: 'zap', text: 'En «Arrival», la xenolingüística (estudio de idiomas alienígenas hipotéticos) pasa de ser un campo teórico a uno urgentemente práctico. Louise Banks enfrenta la pregunta fundamental de la xenolingüística real: ¿qué conceptos son universales en cualquier forma de comunicación inteligente? La película sugiere que los conceptos de referencia (señalar objetos), pregunta-respuesta y negación podrían ser universales. Pero introduce una restricción crucial: los heptapods no tienen concepto de causalidad temporal lineal, lo que hace imposible comunicarse con ellos en términos de "antes" y "después". Louise resuelve esto enseñándoles tiempo simultáneo — pensando como ellos, no adaptando el concepto humano de secuencia.' },
    ],
  },
  {
    id: 'pelicula-arrival',
