...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      { label: 'La danza de las sombras', icon: 'zap', text: 'Durante un paso cenital solar, puedes pararte derecho al mediodía y ver cómo tu propia sombra desaparece debajo de tus zapatos. Los mayas medían estas sombras con estelas altas de piedra para calcular con gran exactitud la duración del año trópico. Es un método sumamente elegante de usar las herramientas de la naturaleza natural.' },
  ...
  },
  {
    ...
    expandables: [
      ...
      { label: 'Matemáticas estelares', icon: 'zap', text: 'El sistema numérico maya era muy elegante. Solo necesitaban tres símbolos básicos para escribir cualquier cantidad enorme: un punto que vale uno, una raya horizontal que vale cinco y un caracol marino que representa el número cero. Fueron una de las primeras civilizaciones mundiales en usar el cero de forma posicional matemática.' }
    ],
  ...
  },
  {
    ...
    expandables: [
      ...
      { label: 'El sonido del cascabel', icon: 'zap', text: 'El cascabel de la serpiente real no tiene piezas adentro que suenen como unas maracas. El sonido peculiar se produce porque los anillos de queratina hueca chocan entre sí muy rápido, unas cincuenta veces por cada segundo. Las estrellas vibran con luz distante; la serpiente vibra con un sonido rápido de advertencia constante.' }
    ],
