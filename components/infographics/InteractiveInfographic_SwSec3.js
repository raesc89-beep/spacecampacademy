...
const BIBLIOGRAPHY = [
  ...
  "Intuitive Surgical (2023). 'Da Vinci Surgical System — Technology Overview.' Intuitive.com.",
...
const INFOGRAPHIC_NODES = [
  {
    ...
    content: [
      ...
      "Lo más fascinante de todo esto es que, así como C-3PO siempre intenta usar su dominio total del lenguaje para mediar conflictos, ayudar a sus amigos humanos y salir de situaciones increíblemente peligrosas, nuestra Inteligencia Artificial del mundo real nos está ayudando enormemente a romper las antiguas barreras del idioma que solían separarnos. Hoy podemos viajar, leer y comunicarnos sin problemas con personas al otro lado del mundo, todo gracias a la misma chispa tecnológica que le dio voz al droide de protocolo más famoso y querido de la galaxia entera."
    ],
    expandables: [
      { 
  ...
  },
  {
    ...
    content: [
      "Todos sabemos que el heroico e inseparable droide astromecánico R2-D2 es el verdadero salvador en innumerables ocasiones durante la saga de Star Wars. Con su cuerpo en forma de barril blanco y azul, R2 repara naves dañadas en pleno vuelo espacial, hackea rápidamente enormes computadoras imperiales enemigas y guarda datos absolutamente vitales para la Alianza Rebelde. Hoy, en nuestro propio sistema solar, la agencia espacial NASA tiene sus propias versiones reales de astromecánicos valientes, pero no exploran la Estrella de la Muerte, sino la superficie polvorienta y desolada del planeta Marte.",
  ...
  },
  {
    ...
    fact: 'El acelerado campo de las interfaces cerebro-computadora (BCI) ha avanzado tanto que en el año 2024, la empresa Neuralink implantó con gran éxito un minúsculo chip neuronal en un paciente humano totalmente paralizado, logrando que controlara el cursor de una computadora solo con pensarlo. Además, investigadores de BrainGate lograron que pacientes similares escriban hasta 90 caracteres por minuto únicamente imaginando el movimiento de sus propias manos escribiendo.'
  },
  {
    id: 'robots-cirujanos',
    ...
    expandables: [
      ...
      { 
        label: '¿Sabías que...?', 
        icon: 'clock', 
        text: 'El genial e innovador robot blando Octobot, inventado por un destacado equipo de la Universidad de Harvard, se convirtió en el primerísimo robot completamente blando y flexible de la historia del mundo. Carece absolutamente de piezas metálicas rígidas y de electrónica tradicional, utilizando sorprendentemente peróxido de hidrógeno como su principal combustible. Esta sustancia química reacciona y se descompone velozmente en forma de un gas inocuo que infla repetidamente sus tentáculos de silicona para poder avanzar.' 
      }
    ],
  ...
  },
  {
    ...
    bannerCaption: 'Atlas puede correr, saltar y hacer parkour — Spot inspecciona fábricas y obras',
    content: [
  ...
  },
  {
    ...
    bannerCaption: 'AlphaFold predijo la estructura de 200 millones de proteínas — Nobel de Química 2024',
    content: [
    ...
    expandables: [
      { 
        label: 'En la Película', 
        icon: 'zap', 
        text: 'En el largometraje "El Episodio I: La Amenaza Fantasma", recordamos la escena donde habitan pavorosas criaturas acuáticas llamadas los destructivos asesinos marinos Opee y los peces garra Colo en la oscuridad de los océanos profundos de Naboo. Qui-Gon, Obi-Wan y el nervioso Jar Jar navegan peligrosamente cruzando estas temibles profundidades en el valiente submarino Bongo. En nuestra propia realidad terrenal, los maravillosos robots de la exploración profunda oceánica deben enfrentar valientemente valientes entornos oscuros que resultan casi tan inexplorados, exóticos, inhóspitos y peligrosos como el propio abismo letal y ficticio que imaginó George Lucas en su mundo de Naboo.' 
      },
      { 
        label: 'Dato Científico', 
        icon: 'atom', 
        text: 'En la prehistoria de AlphaFold, descifrar y modelar la esquiva y diminuta estructura 3D microscópica de una sola y única proteína tomaba entre cuatro y cinco larguísimos años a un estudiante de doctorado utilizando costosos laboratorios de cristalografía de rayos X. Sorprendentemente, la grandiosa IA AlphaFold es ahora perfectamente capaz de lograr predecir en escasos minutos de computadora esa misma e invaluable estructura. En un acto de magnanimidad científica, DeepMind dejó la gigantesca base de datos conteniendo más de 200 millones de valiosas predicciones de proteínas totalmente libre y gratuita al acceso público para más de dos millones de ávidos investigadores provenientes de al menos 190 países del planeta.' 
      }
    ],
    fact: 'El invencible y avanzado robot submarino llamado ROV Jason fue construido expresamente para poder sumergirse velozmente hasta profundidades asombrosas que superan los 6,500 metros en la negrura total del mar, aguantando presiones aplastantes que equivalen a tener el peso descomunal de un automóvil balanceándose únicamente sobre la diminuta superficie de cada centímetro cuadrado de su fuselaje de acero. Aún más increíble fue el año 2012, cuando el atrevido cineasta James Cameron bajó dentro de su submarino modificado Deepsea Challenger hasta los oscuros 10,908 metros de profundidad al interior de la fosa de las Marianas, que es una profundidad total todavía mayor a la asombrosa altura que posee el monte Everest.'
  },
  {
    id: 'futuro-droides',
    ...
    content: [
      ...
      "Pero la mecatrónica moderna y la IA no son, en absoluto, solamente sobre apretar tornillos de metal con una llave y escribir interminables líneas de código fuente en un monitor luminoso; también implican una inmensa y seria responsabilidad moral y social sobre sus hombros. Los geniales pioneros de este campo tecnológico siempre se preguntan si estas grandiosas inteligencias y estas potentes y sofisticadas herramientas robóticas estarán utilizándose siempre por el bien mayor de todos, guiadas por pautas éticas justas. Es en este punto de enorme relevancia donde el antiguo y famoso escritor y maestro de la literatura futurista de ciencia ficción, Isaac Asimov, trazó desde el año 1942 sus inmortales, brillantes e icónicas Tres Leyes de la Robótica, que fueron pilares tan sumamente importantes que más adelante lograron inspirar e impulsar la creación de gigantescos y verdaderos protocolos éticos y manuales de bioseguridad internacional.",
      "El vertiginoso porvenir de nuestro mundo indudablemente rebosará de miles y miles de asombrosos robots caminantes como el deslumbrante Figure 01 y del trabajador humanoide súper masivo Tesla Optimus. Estas magníficas obras mecánicas requerirán urgentemente de niños entusiastas, niñas soñadoras y muchísimos programadores talentosos, nobles y responsables que tengan grandes y brillantes ideas altruistas en sus mentes inquietas para lograr diseñarlos y construirlos maravillosamente bien. Así que no te detengas; si alguna vez miras con curiosidad a R2-D2 y logras pensar y soñar fervientemente que tú podrías haber construido las tuercas de ese increíble androide astromecánico en el garaje de tu propia casa, ¡te invitamos a que te pongas a buscar con valentía un equipo de trabajo, abras inmediatamente las geniales instrucciones de construcción, y des ahora mismo tu gigantesco y emocionante primer paso para que todos juntos puedan, unidos con gran pasión, empezar a forjar y transformar activamente al asombroso y prometedor futuro que nos depara la humanidad!"
    ],
    expandables: [
      { 
        label: 'En la Película', 
        icon: 'zap', 
        text: 'En el mágico y legendario universo expandido de las clásicas películas de Star Wars, podemos observar muy claramente que los cientos de distintos y coloridos androides poseen unas marcadas, vivaces y simpáticas personalidades. Nuestro dorado C-3PO se muestra siempre sumamente ansioso, sumamente cobarde y completamente protocolario y estricto, mientras que el chato R2-D2 es muy temerario, desobediente y sumamente valiente, y finalmente el redondo BB-8 muestra siempre una personalidad sumamente leal e infinitamente curiosa como si fuera un cachorrito. Y a pesar de que exhiben todos estos complejos rasgos tan claramente emocionales, humanos y tan vívidos, a todos ellos tristemente siempre se les sigue tratando fríamente tan solo como una mera propiedad mecánica y se les suelen hacer terribles e injustos borrados masivos forzosos de sus recuerdos internos; un debate que ahora es un increíble, gigante y difícil y gran dilema de derechos reales para nuestros modernos ingenieros y programadores de IA.' 
      },
      { 
        label: '¿Sabías que...?', 
        icon: 'clock', 
