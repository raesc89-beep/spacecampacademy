...
const INFOGRAPHIC_NODES = [
  {
    ...
    content: [
      ...
      "El gran salto de nuestra tecnología ocurrió con el nacimiento de los 'Modelos de Lenguaje Grandes' (LLM). Para que una máquina aprenda a hablar como tú, primero tiene que leer millones y millones de textos de internet, libros enteros, enciclopedias y artículos. A partir de toda esa información masiva, la computadora empieza a notar y memorizar los patrones ocultos que forman nuestras palabras. Es parecido a cómo un bebé humano aprende a hablar, escuchando repetidamente a sus padres, solo que la inteligencia artificial lo hace leyendo bibliotecas enteras en tan solo cuestión de días o semanas.",
      "Imagina que las palabras en una oración extensa son como las piezas sueltas de un rompecabezas complejo. Antes, las computadoras intentaban armar este rompecabezas mirando solamente una pieza a la vez, de izquierda a derecha. Por eso se confundían tanto y hacían traducciones que daban risa. Pero luego los científicos inventaron una arquitectura espectacular llamada 'Transformer'. Los Transformers pueden mirar todas las piezas del rompecabezas al mismo tiempo. Al hacer esto, logran entender perfectamente el contexto, la intención y el significado exacto de toda la frase de forma instantánea.",
  ...
  },
  {
    ...
    expandables: [
      ...
      { 
        label: 'Dato Científico', 
        icon: 'atom', 
        text: 'El asombroso Brazo Protésico Modular desarrollado tenazmente por la Universidad Johns Hopkins posee unos increíbles 26 grados de libertad (que son como articulaciones separadas) e incorpora más de 100 sensores distintos de fuerza y tacto. Otro modelo, el avanzado brazo DEKA, que fue financiado por DARPA. bautizado cariñosamente como el "Brazo Luke" en honor a Luke Skywalker, fue aprobado oficialmente por la estricta FDA en 2014 porque permite hacer tareas complejísimas, como usar llaves para abrir puertas cerradas.' 
      }
    ],
    fact: 'El acelerado campo de las interfaces cerebro-computadora (BCI) ha avanzado tanto. En el año 2024, la empresa Neuralink implantó con gran éxito un minúsculo chip neuronal en un paciente humano paralizado, logrando que controlara el cursor de una computadora solo con pensarlo. Además, investigadores de BrainGate lograron que pacientes similares escriban hasta 90 caracteres por minuto únicamente imaginando el movimiento de sus propias manos escribiendo.'
  },
  {
    id: 'robots-cirujanos',
    ...
    content: [
      ...
      "Una de las mayores y más fabulosas ventajas de este portentoso droide quirúrgico real es que los cortes que realiza son diminutos y exactos, con incisiones que apenas miden un centímetro. Esto hace que la cirugía sea catalogada como 'mínimamente invasiva'. Como resultado de esto, los pacientes sangran drásticamente menos durante la delicada operación, se ahorran gigantescas e incómodas cicatrices, y se logran recuperar. marchar a sus casas muchísimo más rápido que si les hicieran una cirugía abierta tradicional con las enormes herramientas de acero del pasado.",
      "Mirando hacia el futuro cercano, los científicos no se están conformando con crear enormes robots de metal. En prestigiosos laboratorios como los de la Universidad de Harvard, los ingenieros expertos están diseñando una nueva tecnología llamada 'robótica blanda'. construyendo pequeños 'Octobots' hechos enteramente de plásticos suaves y polímeros de silicona flexibles, sin utilizar un solo engranaje o hueso metálico rígido. Estos asombrosos robots blanditos son súper elásticos, lo que les permitirá en el futuro apretujarse y navegar cuidadosamente a través de nuestros delicados vasos sanguíneos o intrincados intestinos humanos sin causar ningún daño interno.",
    ...
    expandables: [
      { 
        label: 'En la Película', 
        icon: 'zap', 
        text: 'En el amargo final de la película "El Imperio Contraataca", es precisamente el eficiente droide médico 2-1B quien trata con éxito las graves heridas sistémicas de Luke Skywalker, además de realizar magistralmente la increíble. Complejísima operación para acoplarle permanentemente su nueva mano biónica. Luego, en"La Venganza de los Sith", observamos cómo varios avanzados droides médicos asisten directamente en el difícil y triste parto doble donde nacen los gemelos Luke y Leia. También conocemos al especializado droide FX-7, que funge como un excelente asistente quirúrgico de múltiple brazos.' 
      },
      { 
        label: '¿Sabías que...?', 
        icon: 'clock', 
  ...
  },
  {
    ...
    fact: 'El invencible y avanzado robot submarino llamado ROV Jason fue construido expresamente para poder sumergirse velozmente hasta profundidades asombrosas que superan los 6,500 metros en la negrura total del mar, aguantando presiones aplastantes. Equivalen a tener el peso enorme de un automóvil balanceándose únicamente sobre la diminuta superficie de cada centímetro cuadrado de su fuselaje de acero. Aún más increíble fue el año 2012, cuando el atrevido cineasta James Cameron bajó dentro de su submarino modificado Deepsea Challenger hasta los oscuros 10,908 metros de profundidad al interior de la fosa de las Marianas. Es una profundidad total todavía mayor a la asombrosa altura que posee el monte Everest.'
  },
  {
    id: 'futuro-droides',
