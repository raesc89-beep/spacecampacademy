...
const DECO_MAP = {
  'noh-ek': [DecoVenusStar, DecoHorizonMarker, DecoDresdenPage],'ciclo-sinodico': [DecoDresdenPage, DecoVenusStar, DecoFeatheredSerpent],'tabla-dresde': [DecoDresdenPage, DecoVenusStar, DecoHorizonMarker],'guerra-estelar': [DecoWarShield, DecoVenusStar, DecoFeatheredSerpent],'kukulkan-venus': [DecoFeatheredSerpent, DecoVenusStar, DecoWarShield],'observacion-tecnicas': [DecoHorizonMarker, DecoVenusStar, DecoDresdenPage],'legado-venusino': [DecoVenusStar, DecoDresdenPage, DecoFeatheredSerpent],
...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      { label: 'El Descubrimiento', icon: 'atom', text: 'El invaluable Códice de Dresde adquirió su curioso nombre europeo porque curiosamente terminó almacenado en la biblioteca real de la ciudad de Dresde, en el país de Alemania. Fue el brillante y dedicado erudito alemán Ernst Förstemann, quien trabajaba allí como humilde bibliotecario a fines de los años 1800s, quien finalmente logró descifrar la complejísima sección matemática dedicada al planeta Venus tras años de esfuerzo.' },
      { label: '¿Sabías que...?', icon: 'clock', text: 'Las detalladas predicciones astronómicas plasmadas en el antiguo Códice de Dresde son tan exactas y perfectas matemáticamente que, incluso si decidiéramos usarlas rigurosamente el día de hoy sin modificaciones, su porcentaje de exactitud de predicción para determinar cuándo reaparecerá Venus superaría asombrosamente el altísimo 99% de precisión. ¡Y esto con tecnología de hace mil años!' },
    ],
  ...
  },
  {
    ...
    fact: 'No todas las feroces batallas clásicas sangrientas entre los antiguos mayas eran formales Guerras Estelares sagradas. El famoso glifo de la Estrella derramando elementos es raro y específico. Se utiliza exclusivamente para registrar y presumir monumentalmente y con tremendo orgullo la derrota humillante total y la captura dramática forzosa del gran gobernante máximo ajaw de la ciudad enemiga, denotando siempre el absoluto colapso total temporal o definitivo de su notable dinastía reinante.',
  },
  {
    id: 'kukulkan-venus',
    ...
    content: [
      ...
      'La mítica y asombrosa historia del majestuoso dios de la Serpiente Emplumada es en sí misma una hermosa alegoría poética e inteligente, diseñada finamente para explicar pacientemente el complicado ciclo cósmico astronómico del luminoso planeta brillante Venus a las grandes masas populares. Según los grandes mitos sagrados narrados en toda Mesoamérica, este compasivo dios fue engañado trágicamente, se inmoló heroicamente en un gran fuego purificador y su enorme y ardiente corazón valeroso e incorruptible ascendió magníficamente a los vastos cielos para convertirse eternamente en la brillante Estrella de la Mañana inmortal.',
    ...
    fact: 'El poderoso arquetipo fundamental de la sagrada deidad creadora y resplandeciente Quetzalcóatl/Kukulcán firmemente conectada con la estrella matutina de Venus es muchísimo y más antiguo de lo que la civilización clásica maya es. Se ha descubierto en ruinas y piezas antiguas de barro que este mito astronómico gran, y venerado compartidamente en toda el área, se rastrea sorprendentemente atrás hasta las asombrosas y milenarias culturas tempranas primigenias mesoamericanas olmecas ancestrales.',
  },
  {
    ...
    fact: 'El conocimiento milenario del registro celeste requería y muy el paso lentísimo y arduo del continuo tiempo histórico dinástico sagrado para así poder eliminar de raíz y sistemáticamente todos los pequeñísimos errores acumulativos e incidentales visuales originados inicialmente. Se ha propuesto que tomó no menos de 300 o hasta de 400 larguísimos y fatigosos años completos continuos de diaria paciencia observacional cuidadosa en los primeros asombrosos asentamientos preclásicos de la jungla el poder ajustar la famosa conmensurabilidad perfeccionada.',
  },
  {
    id: 'legado-venusino',
    ...
    content: [
      ...
      'Hoy, gracias a la minuciosa e incansable labor titánica dedicada mundial constante moderna intelectual cooperativa internacional gigantesca de incontables y notables arqueólogos minuciosos tenaces de muchas lenguas, dedicados lingüistas sagaces decodificadores perspicaces de innumerables textos jeroglíficos crípticos y grandes especialistas mayistas e investigadores rigurosos, entendemos profundamente y admiramos intensamente el profundo enorme brillante talento indígena científico matemático asombroso único intelectual; y su legendario brillante rastro de la majestuosa gran Noh Ek.',
    ],
    expandables: [
      { label: 'Más Exactos', icon: 'atom', text: 'Se considera frecuentemente y muy ampliamente con gran asombro por diversos científicos e historiadores que antes del año aproximado 1500 d.C. Los grandes matemáticos mesoamericanos poseían en general el más preciso asombrosísimo calendario complejo e integral de la entera totalidad total del gran mundo humano global entero, llegando a superar ampliamente la enorme exactitud general y rigor observacional del famosísimo e ilustre gran calendario estandarizado juliano utilizado cotidianamente y profusamente por el viejo imperio de occidente europeo.' },
      { label: '¿Sabías que...?', icon: 'clock', text: 'El conocimiento precolombino astronómico antiguo mesoamericano ha sido reconocido y valiosísimamente validado positivamente en los años de modernidad técnica actual de forma rigurosa y matemática astronómica usando muchísimos modernos potentísimos grandes súper ordenadores computacionales gigantes espaciales, demostrando así y maravillosamente de modo genial indiscutible que sus maravillosas antiquísimas observaciones de piedra rústica tallada fueron en su mayoría correcta e atinadas astronómicas y numéricas.' },
    ],
