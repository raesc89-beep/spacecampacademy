...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      'En 1957, un joven físico llamado Hugh Everett propuso una idea revolucionaria en su tesis doctoral: cada vez que ocurre un evento cuántico â€” como un electrón eligiendo ir a la izquierda o a la derecha â€” el universo se divide en dos. En uno va a la izquierda, en otro a la derecha. Y ambos universos son igual de reales.',
      ...
      'La física detrás se llama «decoherencia cuántica». ¿Recuerdas al gato de Schrödinger? Un gato en una caja está teóricamente vivo Y muerto al mismo tiempo. En la interpretación de Muchos Mundos, ambas opciones ocurren: en un universo el gato vive, en otro no. La «superposición cuántica» es real a nivel subatómico â€” se ha demostrado en laboratorios miles de veces.',
  ...
  },
  {
    ...
    content: [
      ...
      'Kip Thorne â€” quien ganó el Premio Nobel de Física en 2017 por detectar ondas gravitacionales â€” trabajó con Novikov en la fundamentación matemática de este principio. Thorne también fue el consultor científico de la película «Interstellar» (2014), donde estas ideas se exploran visualmente.',
  ...
  },
  {
    ...
    content: [
      'Lo que SABEMOS que funciona: viajar al futuro es real y está comprobado. El GPS corrige efectos relativistas cada día. Los astronautas de la ISS viajan al futuro milisegundos cada misión. En aceleradores de partículas como el CERN, las partículas subatómicas viajan al futuro constantemente â€” muones que deberían desintegrarse en microsegundos sobreviven mucho más porque el tiempo se ralentiza para ellos.',
