...
const INFOGRAPHIC_NODES = [
  {
    ...
    expandables: [
      { label: 'Un Tesoro Rescatado', icon: 'zap', text: 'El daño por agua de 1945 fue un momento crítico. El agua hizo que los pigmentos antiguos comenzaran a correrse y manchar las páginas. Los restauradores tuvieron que trabajar con extremo cuidado durante años para secar el documento sin romperlo. Gracias a fotografías tomadas antes de la guerra, sabemos cómo lucían las partes que se borraron.' },
  ...
  },
  {
    ...
    content: [
      'Un eclipse solar —cuando el día se oscurece repentinamente— aterrorizaba a muchas culturas antiguas. Pero los mayas, en lugar de solo asustarse, decidieron estudiar el fenómeno. En las páginas 51 a 58 del Códice de Dresde, los astrónomos crearon un manual completo para advertir sobre la posible ocurrencia de eclipses solares y lunares. Era su propio sistema de alerta temprana contra la oscuridad.',
      'Para construir esta tabla, los mayas registraron pacientemente las fases de la luna durante generaciones. Descubrieron un patrón matemático asombroso: agruparon 405 meses lunares (lunaciones) que equivalen a 11,960 días. Este número mágico es un ciclo gigante que conecta los movimientos del Sol, la Luna y la Tierra, permitiendo predecir cuándo se alinearán para formar un eclipse.',
      'Las tablas están divididas en 69 grupos de lunas. Para los matemáticos, lo fascinante es que los mayas agruparon los meses en paquetes de 5 y 6 lunaciones. ¿Por qué? Porque descubrieron que los eclipses solo pueden ocurrir en esos intervalos específicos (aproximadamente cada 148 o 177 días). Es como saber que el autobús escolar solo pasa a ciertas horas; si sabes el horario, sabes cuándo estar alerta.',
  ...
  },
  {
    ...
    content: [
      ...
      'Pero no todo era lluvia; los mayas también vigilaban al planeta Marte. En unas páginas fascinantes del códice, los expertos han identificado tablas dedicadas a este planeta rojo. Marte tiene un movimiento extraño en el cielo nocturno llamado "movimiento retrógrado" — a veces parece detenerse y moverse hacia atrás. Los mayas mapearon estos curiosos retrocesos celestiales con gran paciencia.',
      'El almanaque de Marte asocia al planeta con una extraña deidad de largo hocico que desciende del cielo cósmico. El ciclo registrado en estas tablas es de 780 días, que es asombrosamente preciso: el período real en el que Marte y la Tierra vuelven a alinearse con el Sol (período sinódico) es de 779.94 días. Su registro es prácticamente perfecto sin usar herramientas modernas de medición óptica.',
      'Estos almanaques eran manuales prácticos de supervivencia. Los sacerdotes usaban el libro para decirle a la gente cuándo quemar la selva, cuándo sembrar la semilla del maíz y cuándo prepararse para fuertes tormentas. Al combinar los ciclos de Marte, las fases de la luna y las estaciones de lluvia, el códice era una computadora de papel que garantizaba que la civilización tuviera comida cada año.'
    ],
    expandables: [
      { label: 'El Dios Chaac', icon: 'zap', text: 'Chaac es fácilmente reconocible en el códice por su larga nariz rizada y colmillos. A menudo se le representa en grupos de cuatro, cada uno asociado a un color cardinal: rojo (Este), blanco (Norte), negro (Oeste) y amarillo (Sur). Estas direcciones eran fundamentales para predecir el clima agrícola en la península de Yucatán.' },
  ...
  },
  {
    ...
    content: [
      'El Códice de Dresde es un superviviente extraordinario de una de las mayores tragedias culturales de la historia humana. En la actualidad, solo existen cuatro códices mayas auténticos en todo el mundo: el de Dresde, el de Madrid, el de París y el recién validado Códice Maya de México (antes Grolier). ¿Por qué existen tan pocos libros de una civilización que construyó inmensas ciudades y pirámides?',
    ...
    expandables: [
      { label: 'Los Cuatro Sobrevivientes', icon: 'zap', text: 'Los otros tres libros se nombran por las ciudades donde residen actualmente: el Códice de París (que trata sobre rituales), el Códice de Madrid (un manual astrológico para agricultores), y el Códice Maya de México (un fragmento enfocado solo en el planeta Venus, considerado el más antiguo de todos).' },
  ...
  return (
    <div style={{ width: '100%', textAlign: 'center', position: 'relative', zIndex: 2, marginBottom: '-10px' }}>
      <svg viewBox="0 0 600 130" style={{ width: '100%', maxWidth: '600px', height: 'auto', filter: 'drop-shadow(0 0 10px rgba(198,40,40,0.3))' }}>
        ...
        <text x="300" y="80" textAnchor="middle" fill="#C62828" fontSize="20" fontWeight="bold" fontFamily="Georgia, serif" letterSpacing="3">EL CÓDICE DE DRESDE</text>
        <text x="300" y="100" textAnchor="middle" fill="rgba(198,40,40,0.7)" fontSize="11" fontFamily="monospace" letterSpacing="2">EL LIBRO ASTRONÓMICO DE LOS MAYAS</text>
      </svg>
    </div>
  );
}
...
export default function InteractiveInfographic_MayaM15() {
  ...
  return (
    <div style={{
      backgroundImage: 'linear-gradient(180deg, rgba(15,10,10,0.85) 0%, rgba(20,15,10,0.8) 40%, rgba(15,10,10,0.88) 100%), url(/assets/maya/infographic_m15/bg_codex.jpg)',
          ...
          <ul style={{
            ...
            {BIBLIOGRAPHY.map((bib, i) => (
              <li key={i} style={{
                ...
                <span style={{ color: '#C62828' }}>■</span> {bib}
              </li>
            ))}
          </ul>
        </div>
