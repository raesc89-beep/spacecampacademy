...
const INFOGRAPHIC_NODES = [
  {
    ...
    image: '/assets/pioneros/infographic_m4/hero_seleccion.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/pioneros/infographic_m4/hero_nave-vostok.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/pioneros/infographic_m4/hero_orbita.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/pioneros/infographic_m4/hero_regreso.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/pioneros/infographic_m4/hero_legado.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/pioneros/infographic_m4/hero_tereshkova_legacy.jpg',
    content: [
      'Tras su histórico vuelo en el Vostok 6 el 16 de junio de 1963, Valentina Tereshkova jamás volvió a volar al espacio —no por decisión propia sino por orden política. La siguiente mujer soviética en el espacio, Svetlana Savitskaya, no volaría hasta 1982, 19 años después. El motivo oficial nunca se articuló formalmente, pero documentos desclasificados del Kremlin en la década de 1990 revelaron que Nikita Kruschev, satisfecho con el valor propagandístico del vuelo de Tereshkova, no vio utilidad estratégica en continuar el programa de cosmonautas femeninas y lo canceló en 1963. La razón de fondo era que el programa había logrado su objetivo: superar a EE.UU. en la carrera por el primer vuelo femenino.',
      'Tereshkova se convirtió en un icono político de primer orden en la URSS postkruscheviana. Fue elegida diputada del Soviet Supremo en 1966 y presidenta del Comité de Mujeres Soviéticas de 1968 a 1987, convirtiéndose en la representante oficial del país ante organizaciones internacionales de derechos de la mujer durante la Guerra Fría. Su figura fue utilizada sistemáticamente como argumento de que el socialismo soviético había logrado la igualdad de género de facto — una afirmación que era simultáneamente cierta en el caso específico de su vuelo espacial y profundamente falsa en la realidad cotidiana de las mujeres soviéticas, que ocupaban los empleos peor pagados y seguían cargando con la mayoría de las responsabilidades domésticas.',
      'La vida personal de Tereshkova fue objeto de igual grado de control estatal que su carrera. Su matrimonio en junio de 1963 —apenas dos semanas después de su regreso— con el cosmonauta Andrian Nikolayev fue organizado por el Kremlin como un evento propagandístico de primera magnitud: la primera boda entre dos personas que habían estado en el espacio. El nacimiento de su hija Elena Nikolayeva-Tereshkova ese mismo año generó intenso interés científico mundial sobre los posibles efectos de la exposición orbital en la descendencia de ambos padres cosmonautas —Elena nació completamente sana. El matrimonio fue infeliz y terminó en divorcio en 1982, aunque este hecho fue suprimido de la prensa soviética durante años.',
      'En su vejez, Tereshkova mantiene una presencia política activa. En 2020, a los 83 años, fue una de las diputadas que aprobaron las enmiendas constitucionales que permitieron a Vladimir Putin potencialmente gobernar hasta 2036, lo que generó críticas internacionales. En 2013, en el 50° aniversario de su vuelo, declaró públicamente su deseo de volar a Marte "aunque sea sin regreso", una declaración que circuló globalmente y que la convirtió brevemente en tema de debate sobre las misiones tripuladas de un solo sentido a Marte propuestas por el Mars One Project.',
      'El legado de Tereshkova en la historia de la igualdad de género en la ciencia y la exploración espacial es genuinamente ambivalente. Su vuelo demostró biológicamente que las mujeres pueden tolerar el espacio tan bien como los hombres —un hecho que los médicos soviéticos habían debatido— pero el cierre del programa femenino soviético inmediatamente después impidió que ese conocimiento se tradujera en igualdad real dentro del programa espacial por dos décadas. La primera mujer americana en el espacio, Sally Ride, no voló hasta 1983 — 20 años después de Tereshkova —, en parte porque las instituciones aeroespaciales occidentales utilizaron el cierre del programa soviético como argumento implícito de que las mujeres en el espacio no eran una prioridad.'
    ],
    expandables: [
      { label: 'Matrimonio Estatal', icon: 'Star', text: 'La boda de Tereshkova con el cosmonauta Nikolayev fue organizada por el Kremlin como propaganda: la primera pareja de cosmonautas. Su hija Elena nació sana en 1964, demostrando que el vuelo espacial no afecta la reproducción — y luego el matrimonio terminó en divorcio que el Estado suprimió.' },
      { label: 'Sin Regreso a Marte', icon: 'Rocket', text: 'En 2013, a los 83 años, Tereshkova dijo que iría a Marte "aunque sea sin regreso". La primera mujer en el espacio quería ser también la primera persona en Marte — 50 años después del Vostok 6, su deseo de explorar no había cambiado.' }
    ],
    fact: 'Tras su vuelo en 1963, el Kremlin cerró el programa de cosmonautas femeninas porque Kruschev consideró que la propaganda ya había logrado su objetivo. La próxima mujer soviética en el espacio no volaría hasta 1982 — 19 años después. El vuelo de Tereshkova fue más un evento político que el inicio de una revolución de género.'
  },
  {
    ...
    image: '/assets/pioneros/infographic_m4/hero_five_cosmonauts.jpg',
    content: [
      'El programa de cosmonautas femeninas soviéticas comenzó en febrero de 1962 cuando el coronel Nikolai Kamanin, jefe de entrenamiento de cosmonautas, seleccionó a cinco mujeres de un grupo inicial de 58 candidatas: Valentina Tereshkova, Irina Solovyova, Valentina Ponomareva, Tatiana Kuznetsova y Zhanna Yorkina. Las cinco cumplían criterios similares a los masculinos: paracaidistas experimentadas con más de 100 saltos, físicamente robustas, con formación técnica o universitaria, edad entre 18-30 años, peso menor a 70 kg y altura menor a 170 cm. El proceso de selección incluyó pruebas de centrífuga, cámara de vacío, aislamiento sensorial y simuladores de vuelo idénticas a las de los candidatos masculinos.',
      'Valentina Ponomareva, quien quedó en segundo lugar en la selección final, era en opinión de la mayoría de los evaluadores técnicos la candidata con mayor capacidad piloto del grupo. Ingeniería graduada con un piloto licencia real —Tereshkova era paracaidista pero no piloto antes de su selección— Ponomareva había publicado artículos técnicos en revistas de aeronáutica y tenía habilidades matemáticas superiores. Sin embargo, el comité de selección político-militar que tomó la decisión final eligió a Tereshkova por su perfil biográfico: hija de un soldado muerto en la Segunda Guerra Mundial, trabajadora en una fábrica textil, miembro activa del Komsomol —el retrato perfecto de la narrativa soviética del mérito popular sobre el privilegio académico.',
      'Las cinco cosmonautas femeninas fueron entrenadas para misiones específicas planificadas: el vuelo en solitario del Vostok 6 (que realizó Tereshkova), un vuelo en pareja con dos mujeres en Vostoks 7 y 8 que fue planificado para finales de 1963, y una posible caminata espacial femenina antes que los EE.UU. El programa de dos mujeres fue cancelado en octubre de 1963 por razones presupuestarias según la versión oficial, aunque investigadores rusos contemporáneos sugieren que el verdadero motivo fue el desinterés político de Kruschev una vez logrado el vuelo de Tereshkova. Las cuatro mujeres restantes fueron informadas en 1969 de que el programa femenino quedaba definitivamente cancelado.',
      'Irina Solovyova, considerada la mejor paracaidista del grupo, realizó la travesía en solitario del Monte Everest en 1990 y completó cuatro expediciones antárticas como parte de su carrera post-cosmonauta. Tatiana Kuznetsova, descalificada del entrenamiento por razones de salud, se convirtió en matemática y trabajó durante décadas en el Instituto de Física Mecánica de la Academia Soviética de Ciencias. Zhanna Yorkina, la más joven del grupo, se especializó en diseño de trajes espaciales y contribuyó al desarrollo del traje Sokol utilizado en las misiones Soyuz hasta la actualidad. Sus historias demuestran que la selección espacial soviética encontró talentos extraordinarios que simplemente nunca tuvieron la oportunidad histórica de utilizarlos en órbita.',
      'El olvido histórico de las cuatro cosmonautas no seleccionadas contrasta con la atención que han recibido las aspirantes no seleccionadas del programa Mercury 13 estadounidense, cuya historia fue ampliamente documentada y popularizada. La diferencia se debe parcialmente a la transparencia informativa: el programa Mercury era semipúblico, mientras que las candidatas soviéticas fueron clasificadas durante décadas. Los primeros perfiles detallados de las Cinco aparecieron solo en 1989, con la glasnost de Gorbachev, y la documentación completa del proceso de selección no fue desclasificada hasta 2004. Su historia es un recordatorio de que la historia espacial que conocemos es en parte un accidente de la transparencia y la política, no solo del mérito científico.'
    ],
    expandables: [
      { label: 'La Mejor Piloto', icon: 'Star', text: 'Ponomareva era considerada técnicamente superior a Tereshkova — era ingeniera con licencia de piloto real, mientras que Tereshkova era paracaidista. Pero el Kremlin eligió el perfil político perfecto: hija de héroe de guerra, trabajadora de fábrica. La historia espacial también la escribe la propaganda.' },
      { label: 'Desclasificado en 2004', icon: 'Sparkles', text: 'Los perfiles completos de las Cinco fueron secreto de Estado hasta 2004 — 41 años después del vuelo de Tereshkova. La historia que conocemos del programa espacial soviético es solo la parte que el Estado decidió revelar.' }
    ],
    fact: 'Valentina Ponomareva, la cosmonauta que DEBERÍA haber volado según los evaluadores técnicos, fue descartada porque no tenía el perfil político correcto. El programa soviético eligió a Tereshkova por ser "hija del pueblo" — no por ser la mejor candidata. La primera mujer en el espacio fue una decisión de marketing, no de mérito.'
  }
