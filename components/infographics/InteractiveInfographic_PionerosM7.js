...
const INFOGRAPHIC_NODES = [
  {
    ...
    color: '#D87D4A',
    btnImage: '/assets/course/animales_pioneros/btn_sally.jpg',
    image: '/assets/course/animales_pioneros/hero_sally.jpg',
    content: [
      ...
      'El anuncio oficial de su asignación como Especialista de Misión para el vuelo STS-7 del Transbordador Espacial Challenger generó una atención mediática sin precedentes a nivel internacional, enfocándose lamentablemente en muchas ocasiones en cuestiones triviales sobre su género en lugar de sus formidables cualificaciones científicas y técnicas. A pesar de las constantes y a veces condescendientes preguntas de los medios de comunicación acerca de si lloraría bajo presión o sobre las instalaciones a bordo para mujeres, Ride mantuvo un enfoque estrictamente profesional y estoico, redirigiendo pacientemente las conversaciones hacia los objetivos científicos de la misión y la complejidad técnica de las operaciones espaciales. Su actitud profesional y su inquebrantable dedicación a la misión sirvieron para establecer un nuevo estándar de excelencia profesional, allanando el camino para que las futuras generaciones de astronautas femeninas fueran juzgadas y valoradas exclusivamente por sus méritos, capacidades técnicas y contribuciones científicas al programa espacial.',
