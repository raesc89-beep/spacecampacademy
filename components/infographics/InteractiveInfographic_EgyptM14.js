...
function DecoSaros({ size = 65, color = '#FF5252', style = {} }) {
  return (
    <svg width={size} height={size} viewBox="0 0 65 65" style={{ opacity: 0.2, ...style }}>
      ...
      <text x="10" y="36" textAnchor="middle" fontSize="7" fill={color} opacity="0.6">🌍</text>
      {/* Moon */}
      <circle cx="32" cy="32" r="5" fill={color} opacity="0.3" stroke={color} strokeWidth="1" />
      <text x="32" y="36" textAnchor="middle" fontSize="6" fill={color} opacity="0.6">🌑</text>
      {/* Sun */}
...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      'Imagina que estás en el campo hace 3,000 años sin internet, sin televisión y sin que nadie te haya explicado qué es la Luna o cómo funciona el sistema solar. De repente, a pleno mediodía, el cielo comienza a oscurecerse. El sol —que estaba radiante— empieza a tener una mordida que crece poco a poco. Los pájaros dejan de cantar. Las vacas empiezan a caminar hacia el establo como si fuera de noche. La temperatura baja varios grados en minutos. Y entonces el sol desaparece completamente. ¿Qué sentirías?',
      'Para los egipcios, eso era exactamente lo que pasaba cuando Apofis lograba engullir al Sol. Un eclipse solar total puede durar hasta 7 minutos y 32 segundos. Durante ese tiempo, las estrellas aparecen en pleno día, el horizonte se pinta de naranja y rojo, y el corona del Sol —un halo de fuego que normalmente no se puede ver— aparece como una corona dorada alrededor del disco negro. Debía ser uno de los espectáculos más aterradores imaginables para alguien que no sabía que era temporal.',
      'Los eclipses solares ocurren porque la Luna —que es 400 veces más pequeña que el Sol— está exactamente 400 veces más cerca de la Tierra. Este "accidente cósmico" de escala hace que desde la Tierra, la Luna y el Sol parezcan exactamente del mismo tamaño cuando los miramos. Si la Luna fuera un poquito más pequeña o estuviera un poquito más lejos, solo veríamos eclipses parciales, nunca el espectáculo completo. ¡Es literalmente la coincidencia más alucinante del sistema solar!',
      ...
      'Los eclipses lunares (cuando la sombra de la Tierra cubre la Luna) también tenían explicación mítica: eran las pequeñas victorias de Apofis, que mordisqueaba incluso la barca de la Luna en su camino. La Luna roja sangre que vemos en los eclipses lunares totales —causada porque la atmósfera de la Tierra refracta la luz roja hacia la Luna— era, para los egipcios, la sangre de la batalla entre Ra y la serpiente.',
    ],
    fact: 'El eclipse solar total más largo posible dura exactamente 7 minutos y 32 segundos, y ocurre muy raramente. Los próximos grandes eclipses totales son: el 26 de enero de 2028 visible desde España y Portugal (≈5 min), y el 2 de agosto de 2028 visible desde Australia y Nueva Zelanda. Los eclipses totales ocurren en cualquier lugar de la Tierra en promedio una vez cada 375 años. Si vives en el mismo lugar toda tu vida, estadísticamente solo verás uno o dos eclipses totales. ¡Son extraordinariamente raros para los observadores fijos!',
  },
  {
    id: 'ciclo-saros',
    ...
    fact: 'El Eclipse Total de 2099 (12 de septiembre) sobre México durará 6 minutos 22 segundos, uno de los más largos del siglo XXI en América. Ya puedes marcarlo en tu calendario, aunque sea muy lejos. Los astrónomos babilonios del siglo VII a.C. predecían eclipses con una exactitud de ±3 días usando el ciclo Saros. La NASA hoy puede predecir eclipses con precisión de segundos para los próximos 5,000 años. ¡La diferencia es la potencia de cómputo, no el principio matemático!',
  },
  {
    id: 'asteroide-2029',
    ...
    content: [
      'El 19 de junio de 2004, los astrónomos Roy Tucker, David Tholen y Fabrizio Bernardi descubrieron un nuevo asteroide usando el telescopio de la Universidad de Arizona. Cuando calcularon su órbita, algo los dejó sin palabras: el asteroide se acercaba peligrosamente a la Tierra. Lo llamaron "Apophis" en honor a la serpiente del caos egipcia, porque —como la serpiente mítica— este asteroide amenazaba con "destruir el mundo".',
  ...
  },
  {
    ...
    content: [
      ...
      'El legado más profundo del mito de Apofis no es la serpiente ni el caos: es la idea de que el universo exige vigilancia constante y acción colectiva. Los sacerdotes egipcios realizaban sus rituales cada noche, sin excepción, porque sabían que la batalla nunca terminaba. Hoy, miles de astrónomos en todo el mundo trabajan cada noche —también sin excepción— vigilando el cielo para que ningún Apophis real pille a la humanidad desprevenida. Somos los Ra modernos.',
    ],
    fact: 'La probabilidad de que un asteroide del tamaño de Apophis (370 metros) golpee la Tierra en cualquier siglo dado es aproximadamente del 0.016% (1 en 6,250 años). Para asteroides de 1 km, es una vez cada 500,000 años. Para el devastador evento tipo Chicxulub (10+ km), es una vez cada 100 millones de años. El riesgo es real pero gestionable —especialmente si detección y deflexión se invierten adecuadamente. Los egipcios inventaron la vigilancia del cielo. Nosotros la perfeccionamos.',
  },
];

// ─── Animated Chaos Field (stars + serpent-like particles) ────────────────────
function ChaosField() {
      ...
      <div style={{
        ...
        {wasExplored && !isActive && (
          <div style={{
            ...
            <span style={{ color: '#1A0010', fontSize: '10px', fontWeight: 900 }}>✓</span>
          </div>
        )}
        {isActive && (
        ...
        {explored.size === INFOGRAPHIC_NODES.length && (
          ...
          >
            <p style={{ margin: 0, color: '#FF5252', fontSize: '1.1rem', fontWeight: 'bold' }}>
              🐍 ¡Has vencido al Devorador de Soles!
            </p>
