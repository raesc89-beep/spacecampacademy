...
const INFOGRAPHIC_NODES = [
  {
    ...
    image: '/assets/ciencia_arrival/infographic_m6/hero_denis-villeneuve.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/ciencia_arrival/infographic_m6/hero_amy-adams-louise.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/ciencia_arrival/infographic_m6/hero_impacto-cultural.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/ciencia_arrival/infographic_m6/hero_ted-chiang-autor.jpg',
    content: [
    ...
    expandables: [
      { label: 'En la Película', icon: 'zap', text: 'Ted Chiang, autor del cuento original «Story of Your Life» (1998), es uno de los escritores de ciencia ficción más respetados del mundo a pesar de publicar muy poco. Ha ganado cuatro premios Hugo, cuatro Nebula y cuatro Locus — con solo una veintena de relatos en 30 años. Chiang tiene un grado en Ciencias de la Computación y trabaja como redactor técnico de software. Inicialmente rechazó vender los derechos de «Story of Your Life» a Hollywood varias veces, preocupado por la fidelidad. Solo aceptó cuando los productores garantizaron que la película mantendría el núcleo filosófico del cuento: el libre albedrío ante el conocimiento del futuro. La película fue estrenada en el Festival de Venecia 2016 con críticas unánimemente entusiastas.' },
    ],
  },
  {
    ...
    image: '/assets/ciencia_arrival/infographic_m6/hero_linguistica-despues.jpg',
    content: [
    ...
    expandables: [
      { label: 'En la Película', icon: 'zap', text: 'Tras el estreno de «Arrival» en 2016, inscripciones en cursos de lingüística en universidades norteamericanas aumentaron notablemente el semestre siguiente. La lingüista Jessica Coon (consultora técnica de la película) publicó un artículo académico sobre el impacto cultural de la película en la percepción pública de la lingüística. La Sociedad Lingüística de América la citó como "el mayor impulso positivo para la lingüística en la cultura popular desde que Noam Chomsky apareció en documentales en los años 70". La película también popularizó términos académicos como "hipótesis Sapir-Whorf", "logograma" y "lingüística cognitiva" en el vocabulario cotidiano, mostrando cómo la ciencia ficción puede ser el mejor divulgador científico.' },
    ],
  },
  {
    ...
    image: '/assets/ciencia_arrival/infographic_m6/hero_ciencia-ficcion-intelectual.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/ciencia_arrival/infographic_m6/hero_mensaje-final.jpg',
    content: [
