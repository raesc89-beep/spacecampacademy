...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      "Sin embargo, para generar una gravedad terrestre cómoda y que no cause mareos persistentes en un cilindro de unos 100 metros de radio, se necesitaría impulsarlo mecánicamente con un rotor y mantenerlo girando a unas 3 revoluciones por minuto de forma constante y estable."
    ],
    expandables: [
      { 
        label: 'En la Película', 
