...
const INFOGRAPHIC_NODES = [
  {
    ...
    image: '/assets/pioneros/infographic_m3/hero_proyecto-mercury.jpg',
    content: [
      ...
      'El riguroso proceso de selección y entrenamiento de los astronautas del programa Mercury, conocidos mundialmente como los Mercury Seven, estableció un estándar fisiológico y psicológico notablemente alto que definiría el perfil del explorador espacial durante décadas. Los candidatos, exclusivamente pilotos de pruebas militares con vasta experiencia en aeronaves de alto rendimiento, fueron sometidos a regímenes de pruebas médicas y psicológicas que bordeaban los límites de la resistencia humana, simulando perfiles de aceleración extrema en centrifugadoras, descompresión súbita en cámaras de vacío y aislamiento sensorial prolongado, todo con el propósito de asegurar que poseían la resiliencia necesaria para afrontar contingencias imprevistas en un entorno donde el margen de error era cero.',
      'La implementación de una red de seguimiento y comunicaciones de alcance global, la Mercury Space Flight Network (MSFN), constituyó un triunfo logístico y diplomático de la misma magnitud que los logros técnicos del vehículo espacial propiamente dicho. Esta red requería la instalación y coordinación en tiempo real de estaciones de rastreo por radar y antenas de telemetría en ubicaciones remotas alrededor del mundo, incluyendo instalaciones en Australia, Nigeria, España y diversas embarcaciones oceanográficas distribuidas estratégicamente. La capacidad de mantener contacto de voz y recibir datos biométricos y telemétricos críticos del vehículo en órbita fue esencial para la seguridad de la misión y el control operativo centralizado desde Cabo Cañaveral.',
      'La culminación de estos esfuerzos enormes no solo demostró la viabilidad del vuelo espacial tripulado, sino que también catalizó una transformación profunda en la educación, la industria y la percepción pública de la ciencia y la tecnología. El programa Mercury estimuló el desarrollo acelerado de disciplinas como la ciencia de los materiales, la informática de sistemas en tiempo real y la medicina aeroespacial, generando tecnologías derivadas que eventualmente encontrarían aplicaciones vitales en la vida cotidiana. Además, el programa unificó a la nación en torno a un objetivo audaz y pacífico, estableciendo un legado de innovación audaz, meticulosidad en la ingeniería aeroespacial y valor firme que pavimentaría el camino inevitable hacia el programa Apollo y, finalmente, el aterrizaje histórico en la superficie de la Luna.'
    ],
    expandables: [
      {
  ...
  },
  {
    ...
    image: '/assets/pioneros/infographic_m3/hero_vuelo-orbital.jpg',
    content: [
  ...
  },
  {
    ...
    image: '/assets/pioneros/infographic_m3/hero_glenn_1998.jpg',
    content: [
      'El 29 de octubre de 1998, exactamente 36 años, 8 meses y 17 días después de su histórico vuelo en el Friendship 7, John Glenn regresó al espacio a bordo del transbordador Discovery en la misión STS-95. Con 77 años cumplidos, se convirtió en el astronauta de mayor edad en orbitar la Tierra, estableciendo un récord que permanece imbatido. La NASA y Glenn justificaron la misión en términos científicos: estudiar los efectos del envejecimiento en el espacio podría ayudar a entender la osteoporosis, la pérdida muscular y los trastornos del sueño en astronautas — síntomas que son análogos a los del envejecimiento terrestre acelerado.',
      'El STS-95 fue una misión de 9 días y 134 órbitas en la que Glenn participó como Especialista de Carga Útil en lugar de piloto, permitiéndole ser sujeto experimental en varios de los más de 80 experimentos científicos a bordo. Los datos recopilados sobre sus cambios cardiovasculares, óseos y musculares en microgravedad contribuyeron directamente a investigaciones en gerontología, aunque algunos científicos debatieron si una muestra de n=1 aportaba suficiente valor estadístico para justificar políticamente el vuelo de un senador activo de los EE.UU. en ejercicio de su cargo.',
      'La paradoja fisiológica central del regreso de Glenn fue que, a sus 77 años, su cuerpo se adaptó a la microgravedad de forma similar a como lo hacen astronautas mucho más jóvenes — lo que sugería que los mecanismos de adaptación espacial son independientes de la edad cronológica hasta cierto punto. Sin embargo, su período de readaptación a la gravedad terrestre tras el aterrizaje fue notablemente más prolongado que el de sus compañeros de misión, requiriendo más tiempo para recuperar el equilibrio y la fuerza muscular, datos que reforzaron la hipótesis de que el espacio actúa como un "acelerador de envejecimiento" reversible.',
      'El vuelo de Glenn en 1998 fue simultáneamente un triunfo científico, una victoria política y un símbolo cultural. Como senador demócrata de Ohio con 22 años en el Congreso, Glenn había utilizado su posición para mantener vivo el programa espacial durante décadas, y algunos criticaron el vuelo como un "recompensa política". Sin embargo, el impacto mediático fue innegable: 250 millones de personas siguieron el lanzamiento en todo el mundo, más que para cualquier misión tripulada desde el Apollo 11, y las encuestas mostraron que el vuelo aumentó el apoyo público a la NASA en un 12% en las semanas posteriores.',
      'El legado más duradero del regreso de Glenn al espacio fue haber demostrado que las personas mayores pueden tolerar el vuelo espacial con preparación adecuada, abriendo la puerta al turismo espacial para adultos mayores que décadas después se convertiría en realidad. William Shatner (90 años) voló en el Blue Origin New Shepard en 2021, y el programa de investigación sobre ancianos en el espacio que Glenn inició ha evolucionado hasta el estudio actual de cómo las misiones a la Luna y Marte afectarán a la demografía astronauta del siglo XXI, que estadísticamente incluirá candidatos en sus 50s y 60s.'
    ],
    expandables: [
      { label: 'Astronauta más Viejo', icon: 'Star', text: 'Glenn voló a los 77 años y el récord sigue sin romperse. William Shatner (Star Trek) voló con Blue Origin a los 90 años en 2021, pero solo suborbital. El astronauta más viejo en órbita real sigue siendo Glenn, 26 años después.' },
      { label: 'n=1 Controversial', icon: 'Microscope', text: 'Algunos científicos cuestionaron si un solo sujeto de 77 años producía datos estadísticamente válidos. La respuesta de la NASA fue que cualquier dato sobre fisiología de mayores en órbita era mejor que ninguno — y que ningún otro septuagenario había solicitado el puesto.' }
    ],
    fact: 'John Glenn voló al espacio con 36 años de diferencia entre sus dos misiones — de 1962 a 1998. Ningún otro ser humano ha estado en órbita con un gap temporal tan largo entre vuelos, y sus datos fisiológicos a los 77 años siguen siendo la única referencia directa de cómo el espacio afecta a los adultos mayores en órbita real.'
  },
  {
    ...
    image: '/assets/pioneros/infographic_m3/hero_cold_war_space.jpg',
    content: [
      'El Proyecto Mercury no fue concebido primariamente como un programa científico sino como una operación de propaganda geopolítica diseñada para demostrar la superioridad tecnológica y moral de la democracia capitalista sobre el comunismo soviético. El contexto era brutalmente claro: el Sputnik (1957) había demostrado que la URSS podía colocar objetos en órbita, lo que por extensión probaba que sus misiles balísticos podían alcanzar cualquier ciudad norteamericana. Cada fracaso del programa espacial estadounidense era transmitido en televisión en la URSS como evidencia de la decadencia occidental; cada éxito soviético se usaba para reclutar aliados en el Tercer Mundo durante la descolonización.',
      'El vuelo de Yuri Gagarin el 12 de abril de 1961 —21 días antes del vuelo suborbital de Alan Shepard— fue el golpe propagandístico más efectivo de la Guerra Fría. El presidente Kennedy recibió la noticia en silencio durante varios minutos antes de convocar a sus asesores. En las semanas siguientes, datos de inteligencia mostraron que el vuelo de Gagarin había mejorado significativamente la percepción de la URSS en 15 países africanos y asiáticos que negociaban su alineación geopolítica. La respuesta de Kennedy —el discurso de la Luna de mayo de 1961— no fue una decisión científica sino una respuesta de política exterior: comprometerse con la Luna antes de que lo hiciera Kruschev.',
      'El programa Mercury operó bajo una presión psicológica que los astronautas solo describieron públicamente décadas después: cada vuelo era simultáneamente una misión técnica y una actuación política en vivo ante 250 millones de espectadores. John Glenn relató que antes del lanzamiento del Friendship 7, le informaron que si el vuelo fracasaba, el presidente Kennedy daría una rueda de prensa inmediata para "poner en contexto el incidente" — un eufemismo para manejar el desastre propagandístico. La presión sobre el programa era tal que varios ex-astronautas del Mercury reconocieron haber volado con problemas técnicos que habrían justificado abortar la misión, pero que la presión política hacía imposible retrasar.',
      'La competencia entre Mercury y el programa Vostok soviético produjo avances técnicos que ambas superpotencias desarrollaron en paralelo secreto, frecuentemente duplicando el trabajo del otro sin saberlo. La NASA descubrió décadas después que la URSS había desarrollado e implementado computadoras de guía inercial equivalentes a las del Mercury simultáneamente, y que los soviéticos habían tenido sus propios fracasos espectaculares —explosiones en el lanzamiento, fallos de reentrada— que simplemente nunca fueron transmitidos en televisión, a diferencia de los americanos, cuya prensa libre documentaba cada desastre. Esta asimetría informativa creaba la percepción de que la URSS era imbatible cuando en realidad ambos programas tenían tasas de fallo similares.',
      'El legado geopolítico de Mercury se extiende más allá de la Guerra Fría: el principio de que las hazañas espaciales son instrumentos de poder blando definió la diplomacia espacial del siglo XX y continúa haciéndolo en el XXI. El programa Artemis de la NASA para regresar a la Luna en la década de 2020 fue acelerado parcialmente por el anuncio chino de sus planes lunares para 2030; la carrera espacial entre SpaceX/NASA y CNSA/CASC es la versión contemporánea de Mercury vs Vostok. La exploración espacial nunca ha sido solo ciencia: es la forma más visible y costosa en que las naciones comunican al mundo su capacidad tecnológica, organizacional y, en última instancia, su vigor civilizatorio.'
    ],
    expandables: [
      { label: 'Vuelos con Fallas', icon: 'Zap', text: 'Varios astronautas del Mercury reconocieron décadas después haber volado con problemas técnicos que habrían justificado abortar — pero la presión política hacía imposible retrasar. La propaganda necesitaba victorias a tiempo, no victorias perfectas.' },
      { label: 'URSS Ocultó Fracasos', icon: 'Star', text: 'La URSS tenía tasas de fallo de cohetes similares a las de EE.UU. — simplemente nunca los transmitían en vivo. La prensa libre norteamericana documentaba cada explosión, creando la percepción de superioridad soviética que en realidad no existía.' }
    ],
    fact: 'El vuelo de Gagarin mejoró la percepción de la URSS en 15 países del Tercer Mundo que negociaban su alineación en la Guerra Fría. El discurso lunar de Kennedy no fue una decisión científica: fue una respuesta de política exterior para contrarrestar ese efecto diplomático en 21 días.'
  }
