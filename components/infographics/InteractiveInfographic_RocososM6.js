...
const INFOGRAPHIC_NODES = [
  {
    ...
    color: '#FF0054',
    btnImage: '/assets/parker_probe_sun.png',
  ...
  },
  {
    ...
    color: '#8338EC',
    btnImage: '/assets/arcade_planet.png',
    image: '/assets/arcade_planet.png',
    content: [
  ...
  },
  {
    ...
    color: '#00F5D4',
    btnImage: '/assets/apophis_surface.png',
  ...
  },
  {
    ...
    color: '#7000FF',
    btnImage: '/assets/black_hole_singularity.png',
