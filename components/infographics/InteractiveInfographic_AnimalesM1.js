...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      'Los experimentos con insectos sociales, particularmente colonias de abejas y hormigas, revelaron comportamientos emergentes completamente inesperados ante la ausencia del vector gravitacional que estructura la arquitectura de sus sociedades. Las abejas melíferas construyen sus panales orientándose con precisión milimétrica respecto a la vertical gravitacional de la Tierra; en microgravedad, construyeron panales de formas geométricas completamente irregulares y adoptaron rutas de comunicación del tipo "danza waggle" que resultaban ineficaces porque eliminaban el componente gravitacional que codifica la dirección del alimento. Las hormigas, estudiadas en la ISS en 2014, mostraron una capacidad notable para reorganizar sus patrones de forrajeo colectivo en ausencia de gravedad, utilizando principalmente señales químicas feromonales y contacto físico antena-antena para mantener la coherencia de sus tareas cooperativas sin punto de referencia vertical.',
      'Los estudios del ciclo de vida completo de la Drosophila en gravedad cero proporcionaron datos inequívocos sobre los mecanismos moleculares de la orientación geotáctica sin gravedad, abriendo perspectivas de aplicación en la medicina neurológica terrestre. Los investigadores documentaron que, sin el estímulo gravitacional, las larvas de moscas perdían inicialmente su orientación de fotorrespuesta pero la recuperaban parcialmente después de varias generaciones, sugiriendo una plasticidad neuronal adaptativa de ritmo sorprendentemente rápido. Este proceso de compensación sensorial cruzada, donde el sistema visual recluta funciones previamente dominadas por los mecanorreceptores de gravedad, se ha convertido en un modelo de investigación relevante para el desarrollo de terapias de rehabilitación neurológica en pacientes terrestres con daño vestibular severo causado por lesiones o enfermedades degenerativas del oído interno.',
      'La importancia estratégica de los organismos invertebrados y nematodos como Drosophila y C. elegans en la investigación espacial contemporánea no puede subestimarse: representan sistemas biológicos donde es factible realizar estudios genéticos multigeneracionales completos dentro de la duración temporal de una misión espacial típica de seis meses, algo imposible con mamíferos. Las bases de datos moleculares generadas por estos experimentos han identificado docenas de vías genéticas y proteínas candidatas que podrían ser moduladas farmacológicamente para mitigar los efectos nocivos del espacio en el músculo esquelético, el sistema inmune y el envejecimiento celular. En un campo donde cada gramo de carga útil tiene un costo astronómico, la densidad de información biológica por kilogramo de estos pequeños organismos resulta insuperable, convirtiéndolos en los verdaderos caballos de trabajo de la biología espacial del siglo XXI.'
    ],
    expandables: [
  ...
  },
  {
    ...
    content: [
      ...
      'Los alevines, peces en etapa juvenil temprana, demostraron ser particularmente vulnerables a los efectos desestabilizadores de la microgravedad sobre el desarrollo morfológico del sistema esquelético y sensorial, con implicaciones de largo alcance para la comprensión del desarrollo del oído interno en mamíferos. Estudios realizados en la ISS con peces cebra (Danio rerio), otro organismo modelo de primer orden genético, revelaron que los embriones desarrollados completamente en microgravedad presentaban malformaciones sutiles pero estadísticamente significativas en la morfología y composición mineral de los otolitos. Estas anomalías estructurales en los órganos del equilibrio no causaban la muerte del animal pero sí alteraciones persistentes en el comportamiento de natación y la respuesta de sobresalto que permanecían detectables incluso después de que los peces eran devueltos a la gravedad terrestre, sugiriendo períodos críticos del desarrollo donde la gravedad es una señal morfogénica esencial.',
      'Sorprendentemente, después de períodos de adaptación variables que oscilan entre 24 y 72 horas según la especie, muchos peces desarrollan estrategias compensatorias funcionales que les permiten nadar de manera más coherente y ejecutar comportamientos de alimentación aproximadamente normales en microgravedad. Esta notable adaptación neural rápida implica una reorganización de las prioridades sensoriales, donde el sistema visual toma el dominio orientador que antes correspondía a los otolitos gravitacionales. Los peces aprenden efectivamente a usar la iluminación de la pecera orbital o los gradientes de temperatura del agua como sustitutos funcionales del vector gravitacional para definir la orientación espacial básica, un proceso que los neurocientíficos han denominado "reentrenamiento sensorial de sustitución" y que tiene implicaciones directas para el diseño de terapias de rehabilitación en pacientes humanos con vértigo crónico severo.',
      'La investigación con peces en el espacio ha convergido hoy en la herramienta analítica de los peces cebra transgénicos con neuronas fluorescentes, que permiten la visualización en tiempo real del reclutamiento y la plasticidad del circuito neural durante la adaptación activa a la microgravedad. Estos animales, cuya transparencia larvaria completa permite la imagen de todo el cerebro funcionando in vivo, están siendo utilizados en la ISS para identificar los circuitos neuronales exactos que median la transición del control gravitacional al control visual de la postura, con implicaciones terapéuticas directas para los trastornos del equilibrio en pacientes terrestres. El sistema vestibular del pez cebra es, en términos de arquitectura molecular y conectividad sináptica, notablemente homólogo al laberinto del oído interno humano, haciendo de este pequeño pez tropical un puente experimental de extraordinaria relevancia traslacional entre la biología espacial y la neurología clínica de los trastornos del equilibrio.'
    ],
    expandables: [
  ...
  },
  {
    ...
    content: [
      ...
      'Décadas después del OFO-A, experimentos con embriones de ranita africana de uñas (Xenopus laevis) en el transbordador espacial aportaron datos cruciales sobre los efectos de la microgravedad en el desarrollo del sistema nervioso durante los períodos embriogénicos más tempranos y críticos. Los embriones de Xenopus fertilizados en órbita y desarrollados completamente en microgravedad mostraron patrones de segmentación corporal y establecimiento del eje dorsoventral aparentemente normales, lo que descartó que la gravedad fuera indispensable para los procesos de polarización molecular más fundamentales del desarrollo embrionario temprano. Sin embargo, en etapas de desarrollo más tardías correspondientes a la formación del sistema muscular y los órganos del equilibrio, comenzaron a detectarse asimetrías sutiles que persistían hasta la metamorfosis completa, sugiriendo que la gravedad actúa como una señal de verificación de calidad durante ventanas de desarrollo específicas más que como inductor molecular primario.',
      'Los estudios de inmunohistoquímica realizados en ranas post-vuelo revelaron alteraciones microestructurales significativas en la morfología de los máculas utriculares y saculares — las regiones del oído interno donde se ubican los otolitos — que no eran visibles en el comportamiento externo del animal pero que indicaban cambios en la densidad y la organización cristalográfica de los depósitos minerales de carbonato cálcico. Estas modificaciones microestructurales en los órganos otolíticos de las ranas son directamente análogas a las que los neurocientíficos han documentado en los oídos internos de astronautas humanos mediante imágenes de resonancia magnética de alta resolución post-misión, validando así el modelo anfibio como proxy morfológico de alta fidelidad para los cambios vestibulares humanos inducidos por vuelos orbitales. La correspondencia morfológica entre los cambios otolíticos de ranita y humano ha acelerado el desarrollo de pruebas de diagnóstico no invasivas para evaluar la salud vestibular de astronautas sin necesidad de procedimientos endoscópicos del oído interno.',
      'El legado científico de las ranas en el espacio trasciende la fisiología vestibular pura para adentrarse en la biología del desarrollo embrionario en gravedad alterada, la neuroplasticidad adaptativa y los fundamentos moleculares de la percepción espacial. Hoy, los orbitarium experiments con Xenopus en la ISS siguen siendo una herramienta activa de investigación porque la fertilización y el desarrollo embrionario completo de esta especie pueden ocurrir ex utero en un recipiente perfectamente sellado, permitiendo estudiar el impacto de la microgravedad en cada etapa del programa genético del desarrollo sin las complicaciones de la gestación intrauterina. Los investigadores tienen ahora acceso a herramientas moleculares — como el CRISPR-Cas9 aplicado a embriones de Xenopus tropicalis en el espacio — que están comenzando a responder la pregunta fundamental de si la gravedad ha sido evolutivamente incorporada como señal regulatoria directa en los programas de expresión génica del desarrollo, o si simplemente actúa como condición ambiental permisiva de procesos genéticamente autónomos.'
    ],
    expandables: [
