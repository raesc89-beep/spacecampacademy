...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      'Lo verdaderamente alucinante del modelo teórico cosmológico de Randall-Sundrum, es que propone firmemente una regla matemática sumamente restrictiva sobre la naturaleza física fundamental: absolutamente todos los componentes básicos de la materia conocida, como los electrones, la luz solar y los pesados quarks nucleares, están fuerte y perpetuamente pegados e irremediablemente sujetos por los extremos a nuestra propia brana casera, impidiéndoles escapar de ella. No pueden cruzar de ningún modo hacia el abismo del Bulk.',
  ...
  },
  {
    ...
    content: [
      ...
      'Es literalmente tan débil en su inmensa y colosal intensidad de atracción en la realidad tangible del mundo cotidiano que resulta sumamente decepcionante en las comparaciones más evidentes. Piensa por tan solo un fugaz momento revelador: todo nuestro gigantesco y pesado planeta Tierra está intentando continuamente jalar hacia su ardiente núcleo a un pequeñísimo y brillante clip metálico con muchísima fuerza de gravedad, pero basta usar un minúsculo e insignificante imán común de refrigerador para arrebatarle el clip magnéticamente, demostrando la absurda debilidad terrestre.',
  ...
  },
  {
    ...
    content: [
      ...
      'Todo el minucioso, detalladísimo e increíble diseño visual asombroso que despliega bellamente e imponentemente el teseracto cúbico resplandeciente en la brillante y deslumbrante pantalla del cine no es simplemente fruto descontrolado e ignorante de la azarosa creatividad desbordada de Hollywood. Fue un grandioso e intenso trabajo minuciosamente ideado y estrictamente guiado de forma inquebrantable, matemática y seria por el célebre físico ganador del premio Nobel Kip Thorne para plasmar fielmente y de forma visualmente correcta un auténtico entorno matemático extraño de altísimas y laberínticas dimensiones superiores.',
      'Lo que el desconcertado y valiente astronauta extraviado está intentando comprender presenciando con asombro con sus minúsculos ojos en esa luminosa estructura infinita es una inmensamente compleja proyección cósmica tridimensional de un ente enormemente hiperdimensional superior extraño. En este alucinante y retorcido lugar laberíntico, el inmaterial y fluido tiempo ha sido físicamente transformado en una robusta e interminable dimensión espacial sólida que se manifiesta, desenrolla y existe de forma permanente ante él, exactamente y literalmente como si se tratara de una sólida y tangible biblioteca interminable y deslumbrante.',
