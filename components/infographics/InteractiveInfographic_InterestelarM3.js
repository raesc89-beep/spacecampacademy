...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      ...
      { label: 'Como un Azucarillo', icon: 'atom', text: 'Se cree que la densidad típica del núcleo de un cometa es increíblemente baja, a menudo menos de la mitad de la densidad del agua líquida (menos de 0.5 g/cmÂ³). Si pudieras encontrar un océano lo suficientemente grande, la mayoría de los cometas flotarían en él como corcho. Son altamente porosos, una aglomeración suelta de material congelado muy diferente a las rocas sólidas de los asteroides.' }
    ],
