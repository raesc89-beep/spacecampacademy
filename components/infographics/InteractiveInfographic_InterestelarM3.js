...
// ─── SVG Decorative Elements (Comet themed) ────────────────────────────
...
const INFOGRAPHIC_NODES = [
  {
    ...
    fact: 'El cometa fue descubierto cuando se encontraba a unas 3 unidades astronómicas del Sol (tres veces la distancia entre la Tierra y el Sol), mucho más allá de la órbita de Marte. A esa distancia, la temperatura es extremadamente baja, pero ya era suficiente para que los hielos volátiles de su superficie comenzaran a sublimarse y formar la coma brillante que permitió a Borisov detectarlo contra el cielo oscuro.'
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      'Sin embargo, debajo de esa apariencia familiar, se escondía una reliquia alienígena inestimable. Borisov no había sido tocado por el calor de una estrella probablemente en miles de millones de años. Había viajado a través de la gélida negrura del medio interestelar a temperaturas cercanas al cero absoluto. Cuando el calor de nuestro Sol comenzó a calentar su superficie, estaba liberando gases que habían estado congelados y sellados desde la formación de un sistema estelar completamente diferente. Estudiar esa coma no era solo astronomía; era arqueología química de un mundo lejano, ofreciéndonos una muestra gratuita de la nube primordial de otra estrella.'
    ],
    expandables: [
      { label: 'El Verdadero Oumuamua', icon: 'zap', text: 'Mientras Borisov es un cometa clásico rico en hielos volátiles, Oumuamua se comportó más como un asteroide rocoso o un fragmento de planeta destruido, extremadamente seco y desprovisto de polvo visible. Esta diferencia nos enseña que los sistemas estelares eyectan una gran variedad de escombros, y dependiendo de qué parte de su sistema de origen fueron expulsados, pueden ser rocosos o helados. Borisov representa a la población de los confines fríos de su sistema materno.' },
  ...
  },
  {
    ...
    expandables: [
      ...
      { label: 'Como un Azucarillo', icon: 'atom', text: 'Se cree que la densidad típica del núcleo de un cometa es increíblemente baja, a menudo menos de la mitad de la densidad del agua líquida (menos de 0.5 g/cm³). Si pudieras encontrar un océano lo suficientemente grande, la mayoría de los cometas flotarían en él como corcho. Son altamente porosos, una aglomeración suelta de material congelado muy diferente a las rocas sólidas de los asteroides.' }
    ],
  ...
  },
  {
    ...
    expandables: [
      { label: 'La Misión Gaia', icon: 'zap', text: 'El satélite Gaia de la ESA es esencialmente la mejor cámara de mapeo 3D de la historia de la humanidad. Mide con extrema precisión la posición, la distancia y el movimiento propio de más de mil millones de estrellas de nuestra galaxia. Sin el mapa en movimiento de Gaia, habría sido absolutamente imposible intentar rastrear de dónde vino el cometa Borisov, ya que no sabríamos dónde estaban las otras estrellas en el pasado.' },
    ...
    fact: 'El espacio está tan inmensamente vacío que las probabilidades de que un cometa interestelar choque con la Tierra son prácticamente cero. Sin embargo, los astrónomos calculan que, en cualquier momento dado, hay miles de estos pequeños objetos interestelares viajando silenciosamente e invisibles a través de los confines exteriores de nuestro sistema solar, más allá de la órbita de Neptuno.'
  },
  {
