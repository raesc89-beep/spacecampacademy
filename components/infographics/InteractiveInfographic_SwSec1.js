  ...
  },
  {
    ...
    expandables: [
      ...
      { 
        label: '¿Sabías que...?', 
        icon: 'clock', 
        text: 'A pesar de ser una de las mentes más brillantes de su generación y haber descubierto la crucial ley de las variables Cefeidas que permitió a la humanidad medir el universo a gran escala, Henrietta Swan Leavitt no recibió el reconocimiento formal ni el salario que merecía durante su vida en el Observatorio de Harvard. Años más tarde, cuando un colega intentó finalmente nominarla para el prestigioso Premio Nobel de Física por su revolucionaria labor, descubrió con tristeza que ella había fallecido varios años antes, impidiéndole recibir el merecido honor.' 
      }
    ],
