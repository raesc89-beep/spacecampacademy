...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      "Todo esto cambió radicalmente con la llegada de las misiones espaciales. La Agencia Espacial Europea (ESA) lanzó el satélite Hipparcos en 1989 y posteriormente el revolucionario observatorio Gaia en 2013. Libre de las distorsiones de la atmósfera terrestre, Gaia ha logrado medir con una precisión asombrosa las posiciones, distancias y movimientos de casi dos mil millones de estrellas en nuestra Vía Láctea. Este mapa estelar tridimensional sin precedentes es lo más parecido que tenemos en la vida real a las avanzadas computadoras de navegación hiperespacial que utilizan las notables naves del universo de Star Wars."
    ],
    expandables: [
      { 
        label: 'En la Película', 
        icon: 'zap', 
        text: 'En el universo de Star Wars, calcular rutas hiperespaciales es complejo y requiere computadoras de navegación avanzadas ("navicomputers"). Si una nave salta al hiperespacio sin calcular correctamente las posiciones estelares y el paralaje de los objetos astronómicos, corre el riesgo de estrellarse directamente contra una estrella, un asteroide o rebotar cerca del pozo gravitatorio de una supernova masiva, un destino catastrófico. Han Solo describe vívidamente a Luke Skywalker para explicar por qué no pueden simplemente escapar de Tatooine de manera inmediata.' 
      },
      { 
        label: '¿Sabías que...?', 
        icon: 'clock', 
        text: 'La sonda espacial New Horizons de la NASA, tras su histórico y emocionante sobrevuelo de Plutón, viajó tan lejos en los confines oscuros y helados del Sistema Solar que logró capturar el primer paralaje interestelar visible a simple vista. En el año 2020, desde una asombrosa distancia de más de 7 mil millones de kilómetros de la Tierra, la sonda tomó fotografías precisas de las estrellas Próxima Centauri. Wolf 359, las cuales se veían claramente en posiciones distintas y desplazadas en comparación a las que observamos normalmente desde nuestro cálido planeta azul.' 
      }
    ],
    fact: 'Friedrich Bessel midió la primera paralaje estelar de la historia en 1838 para la estrella 61 Cygni. En la actualidad, el telescopio espacial Gaia de la Agencia Espacial Europea ha cartografiado detalladamente casi dos mil millones de estrellas con una impresionante precisión de microsegundos de arco, creando, el mapa tridimensional más detallado de nuestra galaxia jamás concebido por la mente humana.'
  },
  {
    ...
    expandables: [
      { 
        label: 'En la Película', 
        icon: 'zap', 
        text: 'En el universo expandido de Star Wars, los exploradores hiperespaciales y los audaces cartógrafos estelares tenían que descubrir. Documentar gradualmente las rutas seguras de la galaxia a través del tiempo, trazando saltos hiperespaciales apoyados en faros de navegación cósmica (nav beacons) y mapeando meticulosamente los distintos sectores. Así como nosotros construimos la escalera de distancias cósmicas peldaño a peldaño, la antigua civilización galáctica tuvo que expandirse lentamente de sistema en sistema utilizando balizas para no perderse en la vastedad insondable del hiperespacio.' 
      },
      { 
        label: '¿Sabías que...?', 
        icon: 'clock', 
        text: 'A pesar de ser una de las mentes más brillantes de su generación y haber descubierto la crucial ley de las variables Cefeidas. Permitió a la humanidad medir el universo a gran escala, Henrietta Swan Leavitt no recibió el reconocimiento formal ni el salario que merecía durante su vida en el Observatorio de Harvard. Años más tarde, cuando un colega intentó finalmente nominarla para el prestigioso Premio Nobel de Física por su revolucionaria labor, descubrió con tristeza que ella había fallecido varios años antes, impidiéndole recibir el merecido honor.' 
      }
    ],
    fact: 'Henrietta Swan Leavitt descubrió en 1912 la relación período-luminosidad de las estrellas variables Cefeidas, un avance monumental que sentó las bases para medir distancias intergalácticas extremas. Este descubrimiento fundamental fue la clave indispensable que permitió a Edwin Hubble en la década de 1920 demostrar fehacientemente. El universo se está expandiendo y que existen innumerables galaxias gigantescas mucho más allá de las tenues fronteras de nuestra Vía Láctea.'
  },
  {
    id: 'velocidad-luz',
  ...
  },
  {
    ...
    content: [
      ...
      "La atracción gravitatoria de estos colapsos espectaculares es tan asombrosamente colosal e intensa que domina su vecindario espacial cercano. Hay una temida y definitiva frontera o límite invisible alrededor del mortífero agujero negro llamada cariñosamente el 'horizonte de sucesos'. Si algo, incluso la luz más veloz del universo, cruza desprevenidamente esa invisible línea de no retorno gravitatorio, quedará atrapado sin remedio para toda la eternidad. Es por esta simple pero aplastante razón que los denominamos agujeros'negros', ya que no emiten luz.",
      "Quizás el aspecto más contraintuitivo de los poderosos agujeros negros es el fenómeno increíble conocido formalmente en la física relativista como la 'dilatación gravitacional del tiempo'. A medida que un valiente observador espacial se acerca temerariamente a un inmenso campo gravitacional, el tiempo literalmente se ralentiza y frena su ritmo de avance constante para esa persona en relación. comparación con las demás personas que se encuentran lejos, protegidas, seguras y libres de esa distorsión cósmica fundamental y abrumadoramente intensa de la relatividad.",
      "Este asombroso efecto no es exclusivo únicamente de los lejanos monstruos astronómicos; lo experimentamos de forma débil aquí mismo en nuestro planeta. Los relojes atómicos ultra precisos situados dentro de los modernos satélites de GPS en órbita están más lejos de la enorme atracción gravitacional de la Tierra. Nosotros y, en consecuencia, deben corregir su ritmo inexorablemente por 38 microsegundos cada bendito día, ¡o de lo contrario nuestra navegación terrestre se desviaría catastróficamente! Acercarse a un agujero negro llevaría esta loca alteración del tiempo al límite más absoluto."
    ],
    expandables: [
      { 
        label: 'En la Película', 
      ...
      { 
        label: 'Dato Científico', 
        icon: 'atom', 
        text: 'Durante muchas décadas pasadas los notables agujeros negros fueron meramente considerados como unos fascinantes y desconcertantes constructos teóricos o curiosidades matemáticas puras. En el año histórico del 2019, la audaz Colaboración Internacional del Event Horizon Telescope (EHT) publicó con enorme orgullo la primera e histórica fotografía auténtica de la oscura silueta supermasiva del gigantesco agujero negro y su disco brillante de acreción ubicado resplandecientemente en el brillante y agitado corazón de la galaxia Messier 87 (M87*).' 
      }
    ],
    fact: 'El consorcio internacional Event Horizon Telescope Collaboration (EHT) publicó asombrosamente en el glorioso año del 2019 la primera evidencia visual e imagen histórica del agujero negro supermasivo localizado firmemente en el violento. Luminoso centro de la activa galaxia M87*, confirmando con un éxito arrollador e innegable todas y cada una de las grandes y osadas predicciones teóricas hechas por Einstein.'
  },
  {
          ...
          <div style={{ 
            ...
            {shuffledFalcons.map((img, idx) => (
              ...
              >
                ...
                <p style={{ 
                  padding: '0.6rem 0.8rem', margin: 0, fontSize:'0.8rem', 
                  color: '#B0BEC5', 
                  fontFamily: '"Oswald", sans-serif',
                  textAlign: 'center',
                  lineHeight: 1.3
