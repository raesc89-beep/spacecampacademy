...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      { label: 'En la Película', icon: 'zap', text: 'En «Arrival» (2016), la lingüista Louise Banks es convocada precisamente porque el gobierno necesita a alguien que comprenda la diversidad lingüística humana para abordar un idioma completamente ajeno a nuestra especie. Una de las primeras preguntas que hacen los militares es: ¿cuántos idiomas hablas? Louise responde con una lista que incluye mandarín, farsi, portugués y otros. Esto refleja la realidad documentada en la película: las más de 7,000 lenguas vivas del mundo tienen estructuras tan distintas que aprender múltiples idiomas expone al lingüista a formas radicalmente diferentes de organizar la realidad — la preparación perfecta para entender a los heptapods.' },
    ],
  },
  {
  ...
  },
  {
    ...
    expandables: [
      { label: 'En la Película', icon: 'zap', text: 'En «Arrival», la decisión clave de Louise es cambiar de la comunicación oral a la escrita al intentar comunicarse con los heptapodos. Cuando las señales de audio no producen resultados, Louise propone usar pizarras y texto visual. Esta elección no es arbitraria: los heptapodos resultan ser fundamentalmente escritores, no hablantes. Su escritura circular (logogramas) no tiene correspondencia con un sonido — es semántica pura, sin fonética. La película ilustra así la distinción académica entre sistemas de escritura logográficos (como el chino antiguo) y alfabéticos: los primeros comunican significados directos sin pasar por el sonido.' },
    ],
  },
  {
