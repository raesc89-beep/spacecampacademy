...
const INFOGRAPHIC_NODES = [
  {
    ...
    color: '#5B7B9A',
    btnImage: '/assets/reptiles_marinos/marinos_m2.png',
    image: '/assets/reptiles_marinos/marinos_m2.png',
    content: [
