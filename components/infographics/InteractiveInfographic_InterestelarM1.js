...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      'Ponte feliz a jugar, imagina y piensa por un buen rato lo muy difícil y verdaderamente titánico que asombrosamente debe de resultar cazar veloces objetos misteriosos, invisibles, fríos y muy interestelares volando y pasando cerca velozmente; de verdad que la hazaña es enormemente similar a la desesperante y agotadora tarea que sería para intentar, como fotógrafo humano atrapar repetida y nítidamente a un mínimo y pequeño mosquito y pequeñísimo insecto volador veloz y muy escurridizo que cruza corriendo como un misil, volando extremadamente y de modo imparable y muy veloz pasando raudo y silencioso directamente por en medio y el fondo mismo de una casa en habitación completamente negra e increíblemente sumida en oscuridad plena. Para tal logro, los telescopios, cámaras fotográficas celestes y observatorios de hoy en día son extremadamente poderosos.',
      'Semejante hazaña inmensa y gran milagro astronómico, es por ello, el sistema robótico Pan-STARRS. Su maravillosa magia es como la de un solo inmenso y grandísimo, monstruoso ojo súper biónico con mirada telescópica que logra verdaderamente siempre escanear robótica y muy pacientemente en repetidos instantes por milisegundos todo y cada uno de los grandes misteriosos, negros y amplísimos mil y un metros cúbicos y oscuros inexplorados rincones de aquel inmenso y bello cielo nocturno, observando siempre cada madrugada disponible, de una muy extensa y repetitiva e inteligente e iterativa forma rápida y continuamente cíclica mes, incesantemente mes y año, a toda y cada una de nuestras milenarias y viejas grandes estrellas. Su inmensa y gran cámara digital acoplada, instalada a su frente, resulta de ser en el fondo una brillante maravilla mecánica, pues tiene más de mil enormes millones increíbles de puntos sensibles de la misma luz.',
      'Una vez más, durante esa fatídica noche histórica, cuando asombrosa e inusualmente toda la gigantesca e incansable gran red interconectada cibernéticamente por los sensores ópticos de las veloces lentes de los potentes e inmensos ordenadores y supercomputadores masivos acoplados directamente en un punto a la estructura óptica de Pan-STARRS detectó instantáneamente en alerta el paso rápido y movimiento extrañísimo, incomprensible e indescifrable inicial de un apenas detectable, ínfimo y pequeño punto estelar difuso y muy extraño de pequeñísima, casi nula luz moviéndose, corriendo y escapando silencioso, solo a una extraña y tremenda velocidad extremadamente monstruosa, inusualmente altísima para cruzar un cielo local, todo el potente, programado y veloz cerebro del inteligente sistema y software altamente automático levantó una visible alarma electrónica.',
      'De hecho, es por ello que precisamente para poder encontrar siempre y en repetidas innumerables ocasiones miles y miles de misteriosos, negros, veloces y oscuros pequeñísimos objetos fugaces estelares e invisibles en medio del más frío, vacío cósmico interminable de la nada negra y en gran y pesada desesperación galáctica, debemos como civilización inmensamente moderna continuar sin descanso construyendo año tras incesante y caluroso año, muchos y muy potentes, nuevos y mejores colosales y extremadamente ultra y grandes monstruosos gigantes de metales robóticos con inmensas cámaras súper sensibles que logran atrapar con una destreza espectacular fotones únicos, como el de Hawái o el Vera C. Rubin en Chile.',
    ...
    expandables: [
      { label: '¿Sabías que...?', icon: 'clock', text: 'Resulta asombrosamente increíble de creer verdaderamente a simple vista y a primer entendimiento técnico estelar, y el hecho grandioso de que una inmensa y pesadísima sola y gran lente astronómica con su cámara digital robótica fotográfica acoplada para el gigantesco y colosal proyecto e iniciativa observadora global y sudamericana del gran mega Telescopio Observatorio del futuro Vera C. Rubin es gigantescamente enorme.' },
      { label: 'Dato Científico', icon: 'atom', text: 'Increíblemente, cada grandiosa, extensa, gigantesca y laboriosa noche fría cuando la gran máquina observa una pequeñísima, lejana y solitaria diminuta e imperceptible estrella, la computadora gigantesca debe lograr procesar una montaña de fotos. La velocidad extrema y el movimiento propio del objeto que capturó mágicamente su ojo, demostró matemáticamente y geométricamente que venía de lejos y se alejaba más aprisa.' }
    ],
    fact: 'Resulta indiscutiblemente fantástico y por consiguiente muy digno y enorme de ser elogiado y destacado en toda circunstancia histórica con gran pompa e inmensa fanfarria festiva, y también de saber recordar plenamente que el genial y costosísimo observatorio del grandioso invento del famoso súper y muy sensible gran lente telescopio espacial volador infrarrojo y súper oscuro del inmenso espacio estelar, el grandioso e inigualable y espectacular colosal telescopio de oro y cristal espacioso llamado ingeniosamente James Webb espacial es el gran rey y un verdadero mago del espacio, preparado y dispuesto.',
  },
  {
    ...
    content: [
      ...
      'Para variar, y de manera verdaderamente contrastante y rotundamente muy opuesta al silencio estelar, la aparición del caso del segundo, increíble y verdaderamente ruidoso helado segundo visitante estelar fugaz e inconfundible asteroide cósmico que era en verdad el ruidoso gigante cometa interestelar interestelar estelar llamado el famoso 2I/Borisov, fue un evento estelar abismal y maravillosamente completamente grandioso, muy visible, activo, colosal diferente diametralmente abismal y absolutamente e inconmensurablemente muchísimo más, muchísimo pero muy muchísimo más sencillísimo y más increíblemente obvio y muy enormemente muchísimo más descaradamente sumamente inmensamente descarado y grandiosamente obvio e increíblemente sumamente obvio, tan maravillosamente abrumador y gigantescamente sencillo, enormemente muy, muy inmensa fácil de leer estelarmente y tan muy fácilmente.',
      'Es innegable y asombroso para nosotros que esta espectacular diferencia abismal colosal inmensamente extraña y radical gigantescamente química innegablemente resulte entonces ser indudablemente un gigantesco tesoro maravilloso cósmico que resulta ser para nosotros verdaderamente para los grandes exploradores analíticos asombrosamente grandes gigantes de la química grandiosamente astrofísica innegable y espectacular. A niveles muy helados, colosales grandísimas montañas extrañísimas y lejanos oscurísimos astros oscuros con muchísimo monóxido venenoso en la lejana enana rojiza u oscurísima estrella apagada de donde él escapó.'
    ],
    expandables: [
      { label: '¿Sabías que...?', icon: 'clock', text: 'Curiosamente el grandioso y astuto genio, un investigador astrofísico verdaderamente, asombrosa, inusualmente gigantesco profesor muy grande, increíble y de muchísima experiencia catedrática teórica mundial muy brillante de las ilustres estrellas planetarias y profesor experto genio de la famosísima universidad muy estadounidense norteamericana mundial gigante inmenso innegablemente enorme muy grandísima y sumamente gigante mundial y norteamericana Harvard llamado simpática y grandiosamente Avi, publicó grandísima, genial y abrumadoramente gigante inmensa teoría revolucionaria controvertida.' },
      { label: 'Dato Científico', icon: 'atom', text: 'Un maravilloso espectáculo es el asombroso tono verdaderamente increíble hermosísimo grandioso colosal inmensamente grandísimo súper bellísimo increíble súper grandioso muy espectacular rojizo enano gigantescamente enorme increíble, sumamente rojo enano rojizo y misterioso e increíble intensísimo enorme y muy pálido, pardo muy inusualmente hermoso rojizo muy inmenso abrumador rojizo enano hermoso color grandioso. Es por tolina gigante.' }
    ],
    fact: 'Todo este majestuoso enorme inmensísimo innegablemente grandísimo inmensamente colosal y grandioso universo se encuentra todo compuesto del gigantescamente enorme inmenso mismísimo polvo brillante grandioso inmenso de los asombrosos grandísimos y colosales mismos materiales astronómicos en sus profundidades.',
  },
  {
    id: 'futuro-caza',
    ...
    content: [
      'Al asombrosamente considerar profundamente, muy grandemente que indudable e innegablemente los silenciosos objetos espaciales fríos interestelares colosales son maravillosas botellitas de mensajes, parece obvio y claro intentar asombrosamente atraparlas fugaz e inmensamente con grandísima velocidad. Los científicos sueñan atrapar y lograrlo indudablemente grandísimamente inmensamente.',
      'Como grandísimo y espectacular solución colosal a tan grandísimo inmensamente enorme espectacular gigantesco colosal enorme grandísimo inmensurable grandísimo titánico grandioso problemón gigante, en Europa han decidido inmensamente grandiosa inteligentemente enorme genialmente construir grandiosa brillante grandísima Comet Interceptor sumamente genial en grandísimo e inmensamente asombroso.',
      'Luego, de inmediato y espectacularmente al asombroso y esperado instante grandioso de grandísima inmensa alerta espacial grandiosa innegable inmensa grandísima, este brillante inmensísimo hermoso sistema espacial se logrará grandiosa y muy asombrosa despertar e impulsará asombrosamente maravillosamente súper fuertemente hasta volar hacia la inmensa gigante y grandiosa nube espacial hermosa y enorme.',
      'Sin mencionar maravillosamente que otra grandiosa colosal propuesta científica es grandiosísima y genial. El famosísimo sumamente genial inmenso espectacular proyecto genial inmenso llamado grandiosamente muy popularmente grandioso proyecto inmenso Lyra buscaría maravillosamente volar gigantesca e inmensamente más asombrosa rápido veloz genial inmensa hiper veloz astronómicamente hasta alcanzar al primer nómada en un viaje hermoso asombroso lejano.',
      'Todo esto convierte inmensa grandiosa y asombrosa y definitivamente al estudio, muy asombrosa persecución colosal grandiosa asombrosa de lejanos asombrosísimos cometas nómadas y errantes viajeros invisibles espaciales gigantescos en la inmensa, muy maravillosa asombrosa, nueva colosal brillante aventura y más gigantesca frontera maravillosa grandiosa de la exploración inmensamente muy grandiosa e inteligente asombrosamente ciencia brillante humana asombrosamente cósmica y maravillosa innegable.'
    ],
    expandables: [
      { label: '¿Sabías que...?', icon: 'clock', text: 'El increíble inmensamente lejano, genial, asombrosamente escondido oscuro punto espacial orbital maravillosamente grandioso y asombrosamente e invisible vacío llamado genial y grandiosamente punto perfecto asombroso Lagrange dos, que inmensamente es majestuosamente hermoso asombroso grandioso lugar muy tranquilo espacial.' },
      { label: 'Dato Científico', icon: 'atom', text: 'Para viajar maravillosamente gigantesco súper hiper asombrosamente rápido inmensamente voloz grandioso inmenso súper rápido gigantescamente rápido asombrosamente inmensa voloz maravilloso muy grandiosa rápido maravilloso y mágico asombroso rápido veloz, asombrosa inmensa usa propulsores súper asombrosa modernos iónicos.' }
    ],
    fact: 'Nosotros grandiosamente los inmensos increíbles asombrosísimos grandiosos inmensa e increíbles terrestres asombrosa maravillosamente muy humanos y brillantes científicos hemos inmensa asombrosamente lanzado maravillosamente asombrosa colosal grandiosa objetos y naves brillantes, que son ya interéselares asombrosamente.',
  },
];
...
export default function InteractiveInfographic_InterestelarM1() {
  ...
  return (
    <div style={{
      backgroundImage: 'linear-gradient(180deg, rgba(10,12,30,0.85) 0%, rgba(15,10,35,0.8) 40%, rgba(10,12,30,0.88) 100%), url(/assets/interestelar/infographic_m1/bg_interestelar.jpg)',
