...
const INFOGRAPHIC_NODES = [
  {
    ...
    content: [
      ...
      "El problema es que hoy en día no hay tigres en las calles, pero tu amígdala sigue encendiendo la alarma roja cuando tienes un examen difícil de matemáticas, cuando te peleas con tu mejor amigo, o cuando te pones nervioso. Esto hace que tu corazón lata rápido y tus manos suden, igual que si estuvieras en un peligro real. Cuando la amígdala grita fuerte, no deja que otra parte de tu cerebro, la que te ayuda a pensar con claridad y resolver problemas (la corteza prefrontal), haga su trabajo.",
  ...
  },
  {
    ...
    content: [
      ...
      "Por el contrario, si dejas de caminar por un sendero, la hierba vuelve a crecer y el camino desaparece. En la neurociencia, hay un dicho famoso que dice: 'Las neuronas que se disparan juntas, se conectan juntas'. Esto significa que cualquier cosa que practiques repetidamente (tocar el piano, resolver acertijos, o incluso ser paciente) modificará la estructura microscópica de tu cerebro, haciéndote cada vez mejor y más rápido en esa tarea específica.",
      "El duro entrenamiento de un Padawan Jedi en el Templo de Coruscant se basa en esta ciencia de la neuroplasticidad. No nacen sabiendo cómo desviar los disparos láser de los droides de entrenamiento con los ojos vendados. Requiere horas, días y años de repetición incesante. Cada vez que levantan el sable, cada vez que meditan, están forjando y fortaleciendo autopistas neuronales en sus cerebros que les permiten tener reflejos casi sobrehumanos.",
  ...
  },
  {
    ...
    fact: 'Controlar el ritmo de la respiración es la forma más rápida de intervenir conscientemente en el sistema nervioso autónomo. La técnica 4-7-8, al prolongar la fase de exhalación, estimula el nervio vago y reduce el ritmo cardíaco dramáticamente, brindando calma instantánea.'
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "Los Jedi en el templo tienen rutinas estrictas de descanso. Saben que un cuerpo agotado y una mente privada de sueño son blancos fáciles para el Lado Oscuro. Las ilusiones, la impaciencia y la pérdida de control en el uso de la Fuerza son consecuencias directas de no descansar el cerebro. La conexión mística a menudo se revela en los sueños y visiones nocturnas, donde la mente subconsciente está libre del ruido.",
