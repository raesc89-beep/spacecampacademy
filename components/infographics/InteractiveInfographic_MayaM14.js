...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      'El gnomón opera básicamente como el puntero agudo de un inmenso reloj solar terrenal. Conforme la brillante estrella avanza cruzando el cielo diurno, la vara proyecta una sombra oscura que constantemente altera su longitud y dirección. Observando obsesivamente estos mínimos cambios diarios, los mayas descifraron los silenciosos engranajes celestiales. Aprendieron a anticipar las estaciones futuras simplemente registrando cuán corta o larga era la franja de oscuridad al mediodía exacto.',
  ...
  },
  {
    ...
    content: [
      'Presidiendo soberbiamente la urbe de Edzná, encontramos una estructura mágicamente inusual dentro del orbe maya: el imponente Edificio de Cinco Pisos. Imáginate un monumental pastel cuadrado escalonado, alzándose a 31 formidables metros de altura (¡equiparable a una moderna torre de 10 pisos!), construido macizamente utilizando reluciente piedra caliza. Este soberano portento arquitectónico domina majestuosamente la vasta Gran Acrópolis ceremonial.',
      'El aspecto singular de este palacio-pirámide reside en su insólito y funcional diseño "híbrido". Regularmente, los palacios residenciales son largos recintos horizontales, mientras que las pirámides son elevaciones sólidas culminando en reducidos templos cúspides. Sorprendentemente, este gigantesco edificio conjuga magistralmente ambas funciones: sus masivos niveles inferiores ostentan múltiples recámaras habitacionales abovedadas, coronadas por un empinado santuario superior.',
  ...
  },
  {
    ...
    content: [
      'Situémonos mentalmente dentro de un extenso asentamiento edificado sobre barros arcillosos inmanejables, los cuales mutan alternativamente de desoladores pantanos anegados en monzones a yermos polvorientos resquebrajados en estiajes severos. Semejante escenario era el durísimo escollo de la metrópoli. Los valerosos mayas, en lugar de claudicar aterrados, concibieron el más colosal manejo hídrico precolombino registrado, demostrando un indomable tesón ingenieril.',
      'Elaboraron asombrosamente un ramificado tejido integrado por más de treinta kilométricos canales zanjados y formidables embalses artificiales recolectores (aguadas). Figura estas excavaciones como titánicas venas nutricias irrigando la totalidad cívica. El conducto hídrico supremo es verdaderamente monstruoso: supera ampliamente mil metros longitudinales, acaparando cincuenta pasmosos metros horizontales, recolectando la esquiva lluvia y canalizándola controladamente.',
      'Evidentemente, ¿cómo lograba engarzarse la masiva recolección acuífera con las inalcanzables esferas celestiales? Intersecando magistralmente la escrupulosa astronomía con la supervivencia estricta. Las inclemencias climáticas de Edzná gravitaban irremediablemente sobre un ciclo hídrico rígido. Observando analíticamente los imperturbables cenit solares, la jerarquía astrológica presagiaba infaliblemente el arribo perentorio del anhelado temporal lluvioso anual.',
