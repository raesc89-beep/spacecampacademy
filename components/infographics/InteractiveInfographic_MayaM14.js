...
const INFOGRAPHIC_NODES = [
  {
    ...
    content: [
      ...
      'A diferencia de donde vives, en Edzná no había ríos naturales cercanos para obtener agua potable fresca. ¡Imagínate vivir en un sitio caluroso sin agua a la mano! Pero los mayas eran ingenieros audaces que diseñaron un sofisticado sistema hidráulico â€” una enorme red de canales y embalses artificiales para capturar, guardar y distribuir la preciosa lluvia. Literalmente transformaron un terreno salvaje en un paraíso donde el agua fluía controladamente hacia cada rincón.',
  ...
  },
  {
    ...
    content: [
      ...
      'El aspecto singular de este palacio-pirámide reside en su insólito y funcional diseño "híbrido". Regularmente, los palacios residenciales son largos recintos horizontales, mientras que las pirámides son elevaciones sólidas culminando en reducidos templos cúspides. Sorprendentemente, este gigantesco edificio conjuga ambas funciones: sus masivos niveles inferiores ostentan recámaras abovedadas, coronadas por un empinado santuario superior.',
  ...
  },
  {
    ...
    content: [
      ...
      'Elaboraron asombrosamente un ramificado tejido integrado por más de treinta kilométricos canales zanjados y embalses formidables (aguadas). Figura estas excavaciones como titánicas venas nutricias irrigando la totalidad cívica. El conducto hídrico supremo es monstruoso: supera ampliamente mil metros longitudinales, acaparando cincuenta pasmosos metros horizontales, recolectando la esquiva lluvia y canalizándola controladamente.',
      'Evidentemente, ¿cómo lograba engarzarse la masiva recolección acuífera con las inalcanzables esferas celestiales? Intersecando la escrupulosa astronomía con la supervivencia estricta. Las inclemencias climáticas de Edzná gravitaban irremediablemente sobre un ciclo hídrico rígido. Observando analíticamente los imperturbables cenit solares, la jerarquía astrológica presagiaba infaliblemente el arribo perentorio del temporal lluvioso.',
  ...
  },
  {
    ...
    content: [
      ...
      'Habitar perennemente dentro de esta prodigiosa y abrasadora zona geográfica representa ostentar pases de primera fila para atestiguar asombrosos eventos fotónicos. Únicamente dentro de estos delimitados linderos tropicales puede el disco solar situarse a noventa rectos grados sobre nuestra posición anatómica, gestando el fascinante cenit inmaculado. Poblamientos ubicados fuera del perímetro, invariablemente soportan radiaciones oblicuas y persistentes proyecciones de lánguidas sombras vespertinas.',
  ...
  },
  {
    ...
    content: [
      ...
      'No obstante, el rudimentario y falible recuento manual de albas brumosas conlleva inherentes errores acumulativos inevitables. Una prolongada densidad de opacas tormentas tropicales o ligeras dislexias numéricas arruinarían perentoriamente los pronósticos matemáticos. Ambicionaban obsesivamente una inequívoca rúbrica celestial, exenta de debilidad perceptiva humana. El avasallante y absoluto fenómeno de extinción umbría del solemne paso cenital confirió justamente aquella rotunda exactitud irrefutable demandada por sus intrincados dogmas.',
      'Semejante singularidad óptica fáctica â€”aquel transitorio pero apoteósico instante temporal desprovisto de tinieblas proyectadasâ€” ejercía simultáneamente las rigurosas funciones de un majestuoso cronómetro rectificador impecable. Invocado ceremonialmente en la gloriosa jornada central, la apabullante exactitud del mediodía astronómico facultaba a la casta erudita maya para recalibrar instantáneamente cualquier mínimo e indeseado desvío numérico que infestase gradualmente los intrincados papiro-calendarios a lo largo de un turbulento año cívico plagado de anomalías.',
      "Semejando armónicamente un portento relojero integrado por intrincados discos dentados metálicos rotando interminablemente, orquestaron su paradigmática y sagrada 'Rueda Calendárica'. Sincronizando perpetuamente su profundo almanaque esotérico sagrado (Tzolkin) provisto de 260 vibrantes jornadas, conjuntamente operando en paralelo al predecible recuento cívico-solar. Agrícola (Haab') tasado pragmáticamente en 365 días reales; toda esta imponente arquitectura numérica descansaba rectificada y avalada constantemente por las puntuales intersecciones cenitales astronómicas anuales.",
