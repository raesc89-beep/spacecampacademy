...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    expandables: [
      ...
      { label: 'Tecnología Maya', icon: 'atom', text: 'Cada rey en el Altar Q está sentado sobre un glifo (un símbolo de escritura). Ese glifo no es un cojín al azar; ¡es su propio nombre escrito en jeroglífico! Es una forma muy inteligente e ingeniosa de ponerle etiqueta a cada personaje en la piedra sin ocupar espacio extra en el diseño. Diseño gráfico antiguo al más alto nivel.' },
    ],
    fact: 'El diseño del Altar Q, como un cuadrado perfecto con cuatro lados, representa la visión maya del cosmos. Ellos creían que el universo era plano y cuadrado, con cuatro esquinas asociadas a cuatro direcciones y cuatro colores (Rojo/Este, Negro/Oeste, Blanco/Norte, Amarillo/Sur), sostenido por el ÃƒÂrbol del Mundo en el centro. El altar es, literalmente, un modelo del universo.',
  },
  {
