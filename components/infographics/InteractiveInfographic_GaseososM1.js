...
const INFOGRAPHIC_NODES = [
  ...
  {
    id: 'lunas-gaseosos',
    title: 'Las Lunas de los Gigantes: Mundos Dentro de Mundos',
    color: '#FFB74D',
    btnImage: '/assets/course/viaje-planetas-gaseosos/btn_lunas-gaseosos.jpg',
    image: '/assets/course/viaje-planetas-gaseosos/hero_lunas_gaseosos.jpg',
    content: [
      'Los cuatro planetas gaseosos del sistema solar tienen colectivamente 217 lunas confirmadas, de las cuales 95 pertenecen a Júpiter, 146 a Saturno, 28 a Urano y 16 a Neptuno —con varios satélites menores pendientes de confirmación en todos los sistemas. Esta proliferación de satélites es consecuencia directa de la enorme masa gravitacional de los gigantes gaseosos, que capturó asteroides del cinturón exterior durante los primeros 500 millones de años del sistema solar cuando los planetas migraron de sus órbitas originales. Las cuatro lunas galileanas de Júpiter —Ío, Europa, Ganímedes y Calisto— fueron descubiertas por Galileo Galilei en enero de 1610, y su observación moviéndose alrededor de Júpiter fue la primera evidencia directa de que no todos los objetos celestes orbitan la Tierra.',
      'Europa, la luna más pequeña de las galileanas con un diámetro de 3,121 km, es considerada el lugar del sistema solar con mayor probabilidad de albergar vida extraterrestre. Debajo de su superficie helada de 10-30 km de espesor existe un océano líquido de agua salada de al menos 100 km de profundidad —más agua total que todos los océanos terrestres combinados— mantenido líquido por las fuerzas de marea de la enorme gravedad de Júpiter. El sondeo gravitacional de la nave Galileo en la década de 1990 detectó perturbaciones en el campo magnético de Júpiter consistentes con un océano conductor de electricidad —es decir, salado— dentro de Europa, y la misión Europa Clipper de la NASA, lanzada en 2024, está realizando 49 sobrevuelos para caracterizar en detalle este océano subsuperficial.',
      'Ío, la luna más cercana a Júpiter de las galileanas, es el cuerpo geológicamente más activo del sistema solar, con más de 400 volcanes activos que liberan 100 veces más energía por área que la Tierra. La fuente de esta energía es la disipación de mareas: las interacciones gravitacionales entre Júpiter, Europa y Ganímedes mantienen a Ío en una órbita ligeramente elíptica que hace que su interior sea continuamente "amasado" por las fuerzas de marea, generando calor fricional. Los volcanes de Ío lanzan columnas de dióxido de azufre hasta 500 km de altura y depositan superficies de sulfuro de azufre que dan al satélite su característica coloración amarilla-naranja-blanca. Ío también alimenta el toro de plasma que rodea Júpiter con 1 tonelada de material ionizado por segundo.',
      'Titán, la mayor luna de Saturno y la segunda más grande del sistema solar, es el único satélite con una atmósfera densa —1.5 veces la presión atmosférica terrestre— y el único mundo conocido además de la Tierra con lagos y ríos de líquido estable en su superficie. Estos lagos, sin embargo, no contienen agua sino metano y etano líquidos, con temperaturas superficiales de -179°C. El ciclo meteorológico del metano en Titán —evaporación, nubes, lluvia, ríos, lagos— es análogo al ciclo del agua en la Tierra pero con un hidrocarburo como solvente. La misión Dragonfly de la NASA, que llegará a Titán en 2034, es un helicóptero nuclear que explorará docenas de sitios en la superficie, buscando precursores químicos de la vida que podrían existir en las moléculas orgánicas complejas detectadas por la sonda Cassini.',
      'Encélado, una luna de Saturno de solo 504 km de diámetro, fue la mayor sorpresa de la misión Cassini cuando en 2005 se descubrió que expulsa géiseres de vapor de agua y partículas de hielo a través de grietas en su polo sur, lanzando material directamente al anillo E de Saturno. Este material proviene de un océano subsuperficial de agua líquida que contiene, según análisis espectroscópicos de Cassini, hidrógeno molecular, dióxido de carbono y compuestos orgánicos complejos —exactamente los ingredientes que en la Tierra caracterizan los respiraderos hidrotermales del fondo oceánico, donde florece la vida quimiolitoautótrofa. La concentración de hidrógeno molecular indica que en el fondo del océano de Encélado se producen reacciones hidrotermales activas, convirtiendo a esta pequeña luna en otro candidato prioritario para la búsqueda de vida en el sistema solar.'
    ],
    expandables: [
  ...
  },
  {
    ...
    content: [
      ...
      'Los anillos están siendo erosionados actualmente por un proceso llamado "lluvia de anillos", en el que las partículas de hielo son ionizadas por la radiación UV del Sol y caen en espiral hacia Saturno siguiendo las líneas del campo magnético del planeta, precipitando en las regiones ecuatoriales a una tasa de 10,000-100,000 kg por segundo. A este ritmo, los anillos principales desaparecerán completamente en 100-400 millones de años —un abrir y cerrar de ojos en términos geológicos. Las generaciones futuras de humanos, si existen dentro de 300 millones de años, verían un Saturno sin anillos desde su propio planeta, un escenario que hace reflexionar sobre la fugacidad de las características que consideramos permanentes en el cosmos.',
      'La estructura detallada de los anillos revela una dinámica gravitacional de extraordinaria riqueza. La División de Cassini, la brecha oscura de 4,800 km de anchura entre los anillos B y A, está causada por una resonancia orbital 2:1 con la luna Mimas: las partículas en esa región órbitan Saturno exactamente dos veces por cada órbita de Mimas, y las perturbaciones gravitacionales resonantes expulsan gradualmente el material. La sonda Cassini también descubrió "propellers" — estructuras en forma de hélice de decenas de km creadas por moonlets de 100-1000 m de diámetro incrustados en los anillos, demasiado pequeños para ser fotografiados directamente pero detectados por las perturbaciones que crean en el material circundante.',
      'Los anillos de Saturno son uno de los mejores laboratorios naturales para estudiar la formación de discos protoplanetarios — los discos de gas y polvo que rodean las estrellas jóvenes y dan origen a los planetas. Los mecanismos físicos que estructuran los anillos de Saturno (resonancias de Lindblad, ondas de densidad, inestabilidades gravitacionales de Jeans, fricción de polvo) son los mismos que determinaron cómo los planetas del sistema solar se formaron hace 4,500 millones de años a partir de un disco similar. Estudiar los anillos de Saturno en tiempo real con la sonda Cassini fue, en cierta medida, como observar en alta resolución un disco protoplanetario en miniatura.'
    ],
    expandables: [
  ...
  {
    id: 'exploracion-gaseosos',
    title: 'Misiones a los Gigantes: Voyager, Galileo, Cassini y el Futuro',
    color: '#80DEEA',
    btnImage: '/assets/course/viaje-planetas-gaseosos/btn_exploracion-gaseosos.jpg',
    image: '/assets/course/viaje-planetas-gaseosos/hero_cassini_saturn.jpg',
    content: [
      'Pioneer 10 y Pioneer 11 fueron las primeras sondas en cruzar el cinturón de asteroides y alcanzar Júpiter (1973 y 1974 respectivamente), demostrando que el espacio exterior al cinturón de asteroides era navegable para naves no tripuladas. Las imágenes de Júpiter que enviaron Pioneer —aunque de baja resolución— revelaron la Gran Mancha Roja como un sistema de alta presión persistente y permitieron medir el campo magnético joviano, 14 veces más intenso que el terrestre. Pioneer 11 continuó hasta Saturno en 1979, proporcionando las primeras mediciones de sus anillos y confirmando la presencia del anillo F, una estructura estrecha y trenzada que desconcertó a los físicos de la época.',
      'Las sondas Voyager 1 y 2, lanzadas en 1977 y aún operativas, realizaron lo que se conoce como el "Gran Tour" del sistema solar exterior, aprovechando una alineación planetaria que ocurre cada 176 años. Voyager 1 sobrevoló Júpiter en 1979 y Saturno en 1980; Voyager 2 voló por los cuatro gigantes gaseosos entre 1979 y 1989. Las imágenes de los sobrevuelos de Voyager transformaron a Júpiter, Saturno, Urano y Neptuno de puntos de luz en mundos con personalidad propia: descubrieron los anillos de Urano y Neptuno, los volcanes de Ío, los géiseres de nitrógeno de Tritón, y las nubes en bandas de todos los gigantes con una resolución nunca antes lograda.',
      'La misión Galileo de la NASA (1995-2003) fue la primera en orbitar Júpiter en lugar de simplemente sobrevolar el sistema. Galileo lanzó también una sonda atmosférica que descendió 160 km en la atmósfera de Júpiter en diciembre de 1995, transmitiendo datos durante 58 minutos antes de ser aplastada por la presión. La sonda detectó relampagueo joviano 10 veces más energético que en la Tierra, vientos de 180 m/s (648 km/h) y una abundancia de helio menor a la esperada por modelos solares —un misterio que sugiere que el helio se precipita en el interior de Júpiter hacia el núcleo, separándose del hidrógeno a altas presiones.',
      'La misión Cassini-Huygens (1997-2017) es considerada una de las más exitosas de la historia de la exploración planetaria. Cassini orbitó Saturno durante 13 años y 76 días, completando 294 órbitas y realizando 162 sobrevuelos de sus lunas. La sonda Huygens de la ESA descendió en Titán en enero de 2005 y transmitió durante 72 minutos, revelando ríos de metano esculpidos, playas de guijarros de hielo de agua y una atmósfera naranja densa. Cassini terminó su misión el 15 de septiembre de 2017 con una maniobra final deliberada: se precipitó al interior de Saturno para evitar contaminar sus lunas potencialmente habitables, transmitiendo datos hasta el último momento antes de desintegrarse en la atmósfera.',
      'Las próximas grandes misiones a los gigantes gaseosos incluyen la Europa Clipper de la NASA (lanzada en 2024, llegará a Júpiter en 2030), la misión JUICE de la ESA (llegará al sistema joviano en 2031) y Dragonfly (llegará a Titán en 2034). Europa Clipper realizará 49 sobrevuelos de Europa midiendo el grosor del hielo superficial, la salinidad del océano subsuperficial y buscando compuestos orgánicos en el material eyectado por posibles géiseres. La posibilidad de detectar biosignaturas químicas en el material que Europa "exhala" al espacio podría hacer de este sobrevuelo la primera evidencia indirecta de vida extraterrestre en la historia de la exploración espacial.'
    ],
    expandables: [
