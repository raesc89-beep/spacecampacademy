...
const INFOGRAPHIC_NODES = [
  {
    ...
    content: [
      '¡Imagina que pudieras construir una máquina para viajar al pasado y conocer a tus abuelos cuando eran niños! Esa es la magia del viaje en el tiempo. En la película Regreso al Futuro (1985), esta idea cobra vida de una manera espectacular. En lugar de una caja aburrida, el inventor Doc Brown utiliza un coche deportivo DeLorean para saltar a través de las décadas. ¡Viajar en el tiempo nunca había tenido tanto estilo!',
  ...
  },
  {
    ...
    content: [
      ...
      'Aunque la física de Newton nos permitió enviar cohetes a la Luna y construir los edificios en los que vivimos, resultó que no contaba toda la historia sobre el tiempo. A principios del siglo XX, un joven empleado de patentes llamado Albert Einstein estaba a punto de romper ese reloj universal de Newton en mil pedazos. ¡El tiempo estaba a punto de volverse elástico!'
    ],
    expandables: [
  ...
  },
  {
    ...
    fact: 'Stephen Hawking odiaba las paradojas temporales. Propuso que las leyes de la física deben tener un mecanismo de defensa incorporado (que él llamó "Protección de la Cronología") que impide viajar al pasado, ¡solo para mantener el universo a salvo de los historiadores entrometidos!'
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      'El mayor legado de la máquina del tiempo de Doc Brown no es si es posible construirla o no. Es el mensaje de que el universo es maravilloso, extraño y está esperando que lo comprendamos. Nos enseña que la ciencia, el ingenio humano y un poco de locura inventiva pueden llevarnos a descubrir los secretos más profundos del cosmos.'
    ],
    expandables: [
