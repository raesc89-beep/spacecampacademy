...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      'Cuando el software detecta un objeto que se mueve a una velocidad inusualmente alta o en una trayectoria extraña â€”como cayendo desde arriba o abajo del plano del sistema solarâ€”, hace saltar las alarmas de inmediato. Los objetos interestelares como \'Oumuamua se mueven tan rápido que a veces no dejan un simple punto en la imagen, sino una raya alargada. El software moderno está diseñado específicamente para detectar estos trazos rápidos antes de que el objeto desaparezca para siempre en la oscuridad.'
    ],
    expandables: [
  ...
  },
  {
    ...
    content: [
      ...
      'Debido a esta velocidad vertiginosa, no se quedan mucho tiempo. Cruzan la región interior del sistema solar â€”la zona donde los telescopios terrestres tienen oportunidad de verlos porque están lo suficientemente cerca y cálidos para brillarâ€” en cuestión de semanas o unos pocos meses. Si un telescopio de rastreo no escanea el cielo exacto en el momento justo, el objeto se desvanecerá en la negrura del espacio profundo antes de que sepamos que estuvo aquí.',
  ...
  },
  {
    ...
    content: [
      ...
      'Esta sincronización global es lo que finalmente nos permitirá atrapar y estudiar a 3I. El futuro de la defensa planetaria y la exploración interestelar depende de que las naciones y los científicos compartan sus datos de manera abierta e instantánea. La red de vigilancia nos recuerda que el cielo nocturno no tiene fronteras políticas, y que la búsqueda de nuestros orígenes cósmicos es un esfuerzo unificado de toda la especie humana.'
    ],
    expandables: [
