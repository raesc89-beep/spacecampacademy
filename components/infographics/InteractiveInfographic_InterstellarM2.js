...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      'Algunos de estos sistemas alimentados por discos de gas gigantescos generan los notables cuásares, los faros celestes más potentes de toda la creación conocida por la humanidad. Brillan tanto que son el equivalente a colocar una colosal luz de emergencia encendida que ilumina toda la ciudad estelar, eclipsando fácilmente la luz combinada de todas las demás estrellas de su galaxia entera reunidas por los telescopios ópticos, convirtiéndose en balizas cósmicas que permiten estudiar la evolución del universo en sus etapas más tempranas y violentas.',
    ...
    expandables: [
      ...
      { label: '¿Sabías que...?', icon: 'atom', text: 'Los indetenibles chorros de alta energía que son expulsados furiosamente desde los polos magnéticos de los discos de acreción viajan a velocidades espeluznantes, alcanzando la marca de más del noventa y nueve por ciento de la velocidad de la luz en el vacío. Estos emisarios actúan con tanta potencia incontrolable que pueden moldear, alterar y frenar la formación estelar en galaxias vecinas enteras al calentar el gas interestelar frío, regulando de manera efectiva el crecimiento de las estructuras galácticas más masivas en la intrincada red cósmica universal intergaláctica.' }
    ],
