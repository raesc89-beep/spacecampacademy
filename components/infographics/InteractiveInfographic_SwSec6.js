...
const INFOGRAPHIC_NODES = [
  ...
  },
  {
    ...
    content: [
      ...
      "La propuesta científica más realista se basa en la física de los plasmas y el electromagnetismo. Un sistema de protección real implicaría proyectar una capa de plasma muy denso alrededor de un vehículo en fracciones de segundo.",
  ...
  },
  {
    ...
    expandables: [
      ...
      { 
        label: "Dato Científico", 
        icon: "atom", 
        text: "Curiosamente, la ficción cinematográfica anticipó una brillante técnica de la física óptica real conocida hoy como la combinación coherente de haces. Para construir sistemas muy poderosos y evitar que los espejos frágiles se derritan por el calor acumulado, los ingenieros modernos dividen el láser en múltiples rayos independientes de baja intensidad. Justo antes de alcanzar su objetivo distante, estos haces separados convergen perfectamente sincronizados, multiplicando exponencialmente la fuerza total de su impacto sin destruir la delicada maquinaria de disparo interno." 
      },
      {
        label: "¿Sabías que...?",
        icon: "sparkles",
        text: "A pesar del poder abrumador mostrado por la imponente Estrella de la Muerte en el cine, destruir físicamente un planeta sólido del tamaño exacto de nuestra Tierra requeriría aproximadamente dos por diez a la treinta y dos julios de energía bruta. Para poner este número ridículo en perspectiva mundana, necesitarías atrapar toda la deslumbrante producción energética que emite nuestro Sol ininterrumpidamente durante una semana entera y soltarla instantáneamente en un solo destello cataclísmico para lograr un nivel tan extremo de devastación planetaria."
      }
    ],
