...
export default function Spaceship({ 
  ...
  const renderLogo = () => {
    ...
    if (logo === 'spacecamp') {
      ...
      return <img src="/assets/main_logo.png" alt="Space Camp Logo Original" style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '38%', zIndex: 10, filter: 'drop-shadow(0 0 10px rgba(0, 228, 255, 0.5))' }} />;
    }
    if (logo === 'lockheed') {
