export const COURSE_DATA = [
  ...
  },
  {
      ...
      sections: [
        {
          ...
          image: "/assets/black_hole_icon.png",
          imgCaption: "Una ilustración fotorrealista hiper detallada que retrata el majestuoso e implacable poder de un vórtice singular."
        },
        {
          title: "El Horizonte de Sucesos",
          text: "Este límite representa literal y trágicamente el inminente e irreversible punto de 'No Retorno'. Cualquier astronave comandante intrépido que raye escasamente dicha línea invisible fronteriza pasará irremediablemente suplicando a caer al interior triturador del agujero negro eternamente, sin importar que empuje sus hiper-propulsores hacia atrás. La frontera distorsiona el tiempo; desde de afuera parecería el naufragio suspendido en cámara lentísima, perdiéndose difusamente.",
          style: "highlight"
        },
        {
          title: "Fenómeno de Espaguetización",
          text: "Las fuerzas de arrastre provocadas y multiplicadas por densidades negras inagotables resultan tan radicales que producen efectos que estiran mortalmente a los físicos, logrando denominar burlescamente por los científicos reales como 'Espaguetización'. Un cadete precipitando cabeza abajo al centro experimentaría que su casco es halado millones de magnitudes físicas mas fuerte severo que el resto estático opuesto provocando un elástico despedazamiento visual hasta transformarse en hilo puro diminuto de polvo atómico.",
          image: "/assets/black_hole_icon.png",
          imgCaption: "Un núcleo esférico atrapado en la deformación violenta del espacio y tiempo masivo.",
          style: "normal"
        }
      ],
      bibliography: [
    ...
    quizEs: [
      { q: "¿Científicamente, qué viaja suficientemente veloz como para fugarse sano huyendo al exceder y pisar cruzando del letal y siniestro 'Horizonte Sucesos' que corona a los agujeros cósmicos?", options: ["Las ondas puras magnéticas radiales emitidas bajo presión.", "Nada documentado ni la luz lumínica pura más rápida material escapa a esa trampa.", "Los fotones impulsados reactivamente atómicos lumínicos energizados en ráfagas."], a: 1 },
      { q: "¿Cuál es el famoso apodo dado hilarantemente asombroso dentro comunidad científica astrofísica estelar enaltecida al macabro inminente destino mortal por despedazamiento elástico destructivo provocado por diferencias enormes masivas tirando al bucear centro de la gravedad masiva?", options: ["Descomposición atómica.", "Espaguetización de cuerpos.", "Fisura espacio-tiempo estructural."], a: 1 }
    ]
  },
  {
    id: 'quasar', order: 11, 
      ...
      sections: [
        {
          ...
          text: "Concebidos estelarmente de una violenta contradicción, un Cuásar brota curiosamente cuando en el corazón ardiente devorador hambriento voraz de una galaxia activa gigantesca, un singular e inmenso de los referidos Agujeros Negros masivos se 'alimenta' caóticamente devorando mas gas estelar de la periferia a mayor ritmo salvaje insoportable que las presiones estomacales pueden tragar eficientemente.",
          image: "/assets/quasar_icon.png",
          imgCaption: "Dos majestuosos pilares reactivos de luz estelar emitidos desde un núcleo devorador de planetas.",
          style: "normal"
        },
        {
          title: "Chorros de Plasma y Energía",
          text: "Al no tolerar tragarse todo a tiempo ese festín caótico masivo de cometas gasificados puros condensados chocando desorbitadamente en espiral caliente, el disco brillante circundante eyecta literalmente vomitando y disparando chorros letales láser enormes perpendiculares. Éstos rayos emiten tanta luminiscencia radioactiva mortífera intensa encendida sobrepasando brillando astronómicamente hasta por encima a galaxias enteras que hospedan juntos docenas de uniones unificadas en soles y sistemas encendidos a tope.",
          style: "highlight"
        }
      ],
      bibliography: [
    ...
    quizEs: [
      { q: "¿Quién resulta el principal arquitecto creador voraz desencadenante alimentándose voraz de galaxias enteras y polvo cósmico el cual tras atascarse produce erupciones y se conoce llamándolo entonces formal catalogándolo espectacular Cuásar brilloso?", options: ["Un pulsar de gas inestable que se expande por fusión radiactiva.", "El corazón moribundo colosal rojo brillante agonizante viejo remanente en nebulosa.", "Un Agujero Negro Súper-masivo hambriento saturado de materia entrante atascada."], a: 2 }
    ]
  },
  {
    id: 'pulsar', order: 12, 
      ...
      sections: [
        {
          ...
          text: "Imagina concentrar triturando violentamente todo las montañas y rocas pesadas inmensas del enorme e infernal y colosal candente astro gigante el planeta Sol en apneas comprimido una bolita minúscula no más ancha densificada que tu calle ciudad de apenas esferoidal calculada como veinte insignificantes minúsculos kilómetros redondos exactos. El saldo y escombro triturado asfixiante hiper comprimido brutal se conoce majestuosamente asombroso como rotatoria e imparable 'Estrella Densificada Neutrones'.",
          image: "/assets/pulsar_icon.png",
          imgCaption: "Estrellas giratorias imparables cuyos haces magnéticos parpadean en el cielo nocturno preciso.",
          style: "normal"
        },
        {
          title: "Haces Magnéticos y Latidos",
          text: "La presión encogida rotativa brutal estelar, le obliga a dar vueltas y machacar violentamente cientos giros desmesurados constantes en escasos de rápidos segundos diminutos girando al vacío espacial infinito, irradiando rayos emitidos magnéticos fijos destructivos. Esos asombrosos potentes rayos destellantes cruzan el firmamento como faros inmensos portuarios, golpeando escaneando a la órbita de planetas intermedios de los detectores ópticos humanos dándonos rítmicos compaces intermitentes engañosos simulando letales 'Latidos Relámpago'.",
          style: "highlight"
        }
      ],
      bibliography: [
    ...
    quizEs: [
      { q: "¿Bajo qué catalogación se les considera apoda popular asombrosamente referenciando al comportamiento destellante magnético imparable de un orbe pulsar estelar muerto rítmico vibratorio violento orbitando el infinito espacio?", options: ["Faros y Latidos.", "Mártires celestiales fríos.", "Cometas errantes rítmicos."], a: 0 }
    ]
  }
];
