export const COURSE_DATA = [
 ...
 quizEs: [
 { q: "¿Científicamente y como amigable analogía para nuestra base terrenal comparativa por qué llamamos tiernamente Púlsar al mágico remanente muerto giratorio relojero exótico asombroso compacto estrella?", options: ["Porque apaga su luz fúnebre rompiéndose callando extinguiendo oscureciendo su galaxia veloz solitaria negra muerte estelar pasiva apaciguando fría estática y enigmática oscura.", "Porque al girar atronadoramente loco y súper veloz al compás loco y rápido rotacional asombroso, parecen latir y destellar rítmicos fotónicos pulsos latidos luz constante rítmica faroles espaciales guías luz asombrosos rítmicos mágicos eternos rotacionales.", "Por su mágica luz destructiva quemante que fúnebre asfixia y abrasador quema exóticamente letal asfixiada absorbiendo y colapsando luz devorando luz muerta calor atómico oscuro comelon abismal gigante trampa asfixiada mortal."], a: 1 },
 { q: "¿Qué uso invaluable le daremos en naves maravillosas las futuras y valientes amistosas tripulaciones viajeras comandantes estelares asombrosas pacíficas futuras humanas naves al destello maravilloso púlsar exótico?", options: ["Usarlos como hermosos exóticos precisos infalibles rítmicos relojes exactos guías GPS perfectos brillantes para guiarnos sin perder al lejano abismo asombroso mapa espacial.", "Romper exóticos cristales esmeraldas para maravilloso robar absorber energía radiante cálida cósmica pesada recolector exótico calor letal radiactivo atrevido y heroico escudo magnético nave recarga.", "Vivir reposar acortar colonizando y brincando enigmáticos asfixiados al vivir anclados en su costra pesada rocosa estática congelada amigable exótica oscura pacífica estrella y mágica estéril estelar colonia vida cálida luz atardecer cósmica hermosa rocosa roca amigable hermosa superficie magnética plana segura mágica."], a: 0 }
 ]
 },
 {
 ...
 quizEs: [
 { q: "¿En qué inmensa y vital cualidad milagrosa astronómica astrofísica destacan estas enanas rojas veneciendo?", options: ["Poseen un poder destructivo ruidoso y destellante inmensurable.", "Crean hermosos paisajes solares azules calientes.", "Sobreviven perdurando billones y eternos años vitales por economizar consumir tacañamente su gas puro hidrógeno lentamente perezosas ahorrativas únicas."], a: 2 },
 ...
 quizEs: [
 { q: "¿En qué inmensa pacífica y luminosa entidad terminará nuestro querido redondo ardiente Sol radiante?", options: ["Una roja apagada ruidosa explotará colosal.", "Se dormirá comprimido y callado brillante como pálido y comprimido cadáver llamado Enana mágica Blanca solitaria apacible.", "Quedará negro veloz agujero absorbente negro destellando luz veloz letal asfixiante apagón final mudo."], a: 1 },
 { q: "¿Qué asombroso brillante valiosísimo tesoro formaría su corazón compacto duro exóticos endurecidos congelado macizos?", options: ["Piedras rústicas grises sueltas flotantes congeladas sucias fúnebres oscuras opacas sin luz.", "Se aprietan en maravilloso asombroso estético macizo duro hermoso colosal y limpio brillante estelar diamante gigante puro rocoso duro.", "Anillos y estatuas exóticas fluidos magnéticos gaseosos nítidos en nubes calientes hirviendo exóticas cálidas."], a: 1 },
 { q: "¿Qué letal comportamiento caníbal traicionero exóticamente peligroso realizan estas dormidas enanas fantasmales mudo asombroso si habitan junto un solitario amigo sol?", options: ["Atraen asombrosos empuje cósmico robando vida material del exótico vecino a lado asfixiantemente encendiéndose en gran supernova estelar.", "Le regalan ruidosos regalos de luces radiactivas curativas estelares amigables en luz solar bella amigable exótica de la brillante color radiante.", "Detienen silenciosamente apagándose la órbita frenando en paz el cosmos universo rotacional deteniendo rocosas amigables mudas congelaciones apagados infinitos fúnebres destellos de congelamiento de universo sin fúnebre asfixiante amigable ruidosa de detención de paz."], a: 0 }
 ]
 },
 {
 ...
 imgCaption: "Una vista de un asteroide rocoso acompañado por un cometa."
 },
 {
 ...
 text: "Uno de los espectáculos más gloriosos del cielo son las Perseidas. ¿Sabías que en una lluvia de destellos tan , no todos los pedazos de roca o metal se desintegran en polvo ardiente? Los fragmentos macizos y resistentes que triunfantes aterrizan tocando el suelo de la Tierra se catalogan oficialmente como 'Meteoritos'.",
 video: "/assets/asteroides/Perseid Meteor.mp4",
 style: "normal"
 },
 {
 title: "La Inusual y Verdadera Historia de Ann Hodges",
 text: "¡No te asustes, explorador! La posibilidad de impacto letal de un meteorito es increíblemente baja: 1 en la estadística de 1,600,000. Tienes mucha más posibilidad de ser atrapado y golpeado brutalmente en el mismo espacio y tiempo por un letal tornado destructivo, seguido de un feroz huracán acompañado y golpeado de un furioso rayo. Sorprendentemente, Ann Hodges ha sido documentada como la y valiente persona tocada en el universo físico por un meteorito impactándola descansando apaciblemente aquel 30 de Noviembre invernal y heroico del 1954 en el bello Sylacauga.",
 image: "/assets/asteroides/Ann hodges.png",
 imgCaption: "Collage espectacular oficial de la legendaria heroica sobreviviente estelar Ann Hodges e Isabel Anderson del histórico Museo Comer exhibiendo la réplica letal estelar de Sylacauga."
 },
 {
 title: "Meteoritas y el Impacto en México antiguo que lo cambió todo.",
 text: "Nuestro valioso museo de Minería mexicano honra asombrosas y monumentales meteoritas impresionantes de metal pesado colosal extraterrestre. Un lejano coloso gigantesco impactó, y le bautizamos Chicxulub. Hace enormes y asombrosos millones de años un valioso pero fiero colosal destructivo gigante metorito masivo impactó pero atronadora y letalmente las aguas cálidas de la península extinguiendo pero oscuramente de golpe nuestro asombroso paraíso de adorables colosales e imponentes pacíficos letales heroicos impresionantes asombrosos gigantes amigables y grandiosos asombrosos majestuosos fantásticos enormes fieros animales de asombroso período cretácico jurásico dinosaurio histórico monumental .",
 image: "/assets/asteroides/chicxulub_impact.png",
 imgCaption: "Una hermosa reconstrucción imaginaria de ese enorme letal y destructivo pero vital evento celestial de Chicxulub en la histórica brillante y la calurosa de blanca de blanca y a hermosa a brillante Yucatán."
 },
 {
 title: "Meteoritas Mexicanas y caída brutal",
 text: "Estos inmensos y antiguos fragmentos de asombroso metal estelar masivo han dejado huellas innegables en nuestro profundo país y bella cultura. Sumérgete y profundamente en majestuosos asombrosos a este majestuoso impactante video de la deslumbrante caída y el y maravilloso estudio de estas a piedras colosal a de la a y minería oficial Mexicana .",
 ...
 quizEs: [
 { q: "¿Cual imponente objeto sideral de veloz deslumbrante sobrevudeive íntegro intacto al ardiente rozamiento atmosférico fuego y golpea intacto el majestuoso y a de y nuestro suelo profundo de a de a Tierra a ?", options: ["Extraterrestre invasor destructivo.", "Enorme gaseosa roja fúnebre majestuoso a nubosa y a y a .", "Hermoso e indestructible Meteorito triunfante profundo."], a: 2 },
 { q: "¿Cuál es la verdadera de colosal colosal pálido estadística a estadística de probabilidad en a a y a ser impactado brutal a destructivo y brutal por de asombroso de a de un meteorito asombroso a a ?", options: ["De 1 entre deslumbrante 10 personas a .", "De y a a de minúscula a colosales en inmensa 1 y en y 1,600,000 enormes a y a de personas de .", "Típicamente a de 1 a 5 asombroso a."], a: 1 },
 { q: "¿Qué inmensísimo asombroso catastrófico evento causó y originó espectacularmente y asombrosísimamente y a el glorioso a cráter de y a Chicxulub a en majestuoso de maravilloso y asombroso en la península y la a ?", options: ["Un a huracán .", "Un colosal de sismo a de a terrestre de a asombroso.", "El impacto de a destructivo inmenso meteorito majestuoso a a ."], a: 2 }
 ]
 },
 {
 ...
 text: "A diferencia de sus rocosos hermanos asteroides polvorientos, los impresionantes cometas brillan siendo viajeros fríos y misteriosos celestes frígidos cósmicos. ¡Básicamente conforman gigantescas bolas maravillosas compuestas enteramente de gélido antiguo celestial hielo deslumbrante mágico mezcladas en bella espléndida y en a armonía y a de a de a con polvo y antiguos deslumbrante y majestuoso pálido gases brillantes congelados a milenarios a !",
 image: "/assets/asteroides/hub_cometas.png",
 imgCaption: "El espectacular asombroso de y a vagabundo a gélido a y a."
 },
 {
 title: "Una Cabellera Deslumbrante Luminosa",
 text: "Cuando una hermosa misteriosa grandiosa a e roca de gélido a de cometa de a brillante a se la y aventura de cerca a del de y a imponente a y asombroso majestuoso a a de calentísimo de Sol de de e majestuoso... el e místico hielo comienza la a a de a de gélido e vaporizarse, y a formando y a la enorme de y corona de a asombroso brillante gaseosa que de nombramos de a como a la grandiosa a brillante a radiante majestuoso mágica a coma a y a y coma brillante a.",
 style: "highlight"
 },
 {
 title: "La Inmensa Cola de Hielo y Polvo Brillante",
 text: "El gigantesco y majestuoso majestuoso dorado de a invisible a viento solar de solar y empuja a fuertemente el a vapor de y a majestuoso a y a hielo de a asombroso asombroso lejos. de ¡Esto la de majestuoso de y a en a sutilmente fabrica la icónica la de enorme a la y cola blanca y en radiante cola asombroso de y brillante a que a puede a extenderse a de a de a por de e brillantes a millones de a esplendoroso a kilómetros a a brillantes a de grandioso brillantes a a!",
 image: "/assets/asteroides/hub_cometas.png",
 imgCaption: "Cometa esparciendo vaporoso majestuoso y cósmico majestuoso a brillante gélido a rocío solar a brillante a."
 },
 {
 title: "El Viaje de Cometa Neowise Magnífico",
 text: "Completar la y silencio a lenta y de a y vuelta a de la a orbita la y misteriosa enorme orbital y vuelta de y lenta de a y a colosal puede y de tomar de a miles de a de de años y a . de Adéntrate a observando de el paso de del a asombroso Neowise en de a la su de siguiente a el a y a y a de grabación la y la a.",
 video: "/assets/asteroides/Cometa Neowise.mp4",
 style: "normal"
 },
 {
 title: "Mensajeros de los Confines",
 text: "Muchas y de pequeñas rocas a de cometa a habitan en a la en a las en el a oscuro y de a lejano de brillante Cinturón a a a de la de y a de y de a la Kuiper en la y a de el y la a confín a exterior de a de a .",
 style: "highlight"
 },
 {
 title: "Diferencia Total",
 text: "Recuerda: asteroide es de roca de a y a y a a y a sólida, la y de en de meteoro a es la si a de si a de y a cruza a a fuego de a y de a ardiente y cielo y . de Cometa la a es la hielo de a hielo mágico es gélido.",
 image: "/assets/asteroides/hub_cometas.png",
 imgCaption: "Misterio asombroso pálido gélido eterno en a de la maravilloso gélido la a y a ."
 }
 ],
 bibliography: [
 ...
 quizEs: [
 { q: "¿En a e de en a y de grandioso gélido y qué a y a se a de a sutilmente diferencian a asteroides y cometas a a ?", options: ["Color pálido .", "El de sutilmente asteroide es a de y a roca seca a y sólida; a el cometa a esplendorosa y es sutilmente y la de y a hielo a sucio la de mágico de .", "Cometa de la maravilloso a es a fuego de a de a ardiente y ."], a: 1 },
 { q: "¿Qué suceso de la a de y a crea de la de a sutilmente la y a coma y en a la de y la a cola a de un de a majestuoso a de la cometa de a la a y a a?", options: ["El la en de majestuoso a calor a y a de Sol evaporando de la a en a hielo.", "Fricción a atmosférica de destructiva en roja.", "Choque asombrosas a a entre a rocas a de a."], a: 0 },
 { q: "¿En de y qué lugar en de en la lejano y a místico a y de la y se del esconden en de majestuoso a a sutilmente a de y a de la muchos de cometas a gélidos de a la ?", options: ["En sol sutilmente de sutilmente a ardiente rojo.", "Gélido Cinturón de en Kuiper y a en a y a de la Kuiper .", "Órbita a roja de blanca la a la y la."], a: 1 }
 ]
 },
 {
 ...
 text: "¡Hola a de astronauta la! de Los a de asombrosos a asteroides a guardan de a a la de profunda de a receta original del de del a la majestuoso Sistema de a de a Solar. a Para estudiarlos a de , de enviamos en e a astutas a y a y a de a nuestras sondas y de a de la a de y de a como Osiris-Rex la de a y Rosetta de a. en la y a en a ¡A cazar de la y a de misterios de a!",
 image: "/assets/asteroides/hub_sondas.png",
 imgCaption: "Dos astutas y a de naves a la de la en de a valiosas a ."
 },
 {
 title: "Osiris-Rex: Un Beso a Bennu",
 text: "La increíble y de y de y a astronave a Osiris-Rex viajó sutilmente de 11 a 11 a al lejano asteroide oscuro Bennu. Mírala a de aquí en a la acción de y de con este este a y e vídeo a de a a de y de a .",
 video: "/assets/asteroides/Video Osiris Rex.mp4",
 style: "normal"
 },
 {
 title: "Un Polvoriento Estelar Mágico Beso para Traer",
 text: "¡Oh sorpresa a ! Osiris-Rex de a de no la de bajó de la de y de a de en a a la de a de a de plantar a bandera, a le de a dio a un a de beso de ligero a en la y de recogiendo polvo para traer de a la a de a a de de a a Tierra la a la.",
 image: "/assets/asteroides/Osiris rex 3.png",
 imgCaption: "Osiris recogiendo a de a la a a y a polvo de ."
 },
 {
 title: "Rosetta Caza Fiero al Cometa de Hielo",
 text: "Ahora, la a sonda europea Rosetta a se de en la en fue a persiguiendo de no al a de y a de y a y a la de la a de cometa a 67P de a en . Valora esta a de a 67P de la a de en a la en a primera la a a a y la de persecución a en a en a en de video a .",
 video: "/assets/asteroides/Video Rosseta.mp4",
 style: "normal"
 },
 {
 title: "Rosetta Parte Dos y Acción de 67P",
 text: "Puedes la a y de ver la su segundo paso de a la brillante la a a al la a cometa de de a y a de y la 67P en de su de y la a de a de a en a en de en e la a este asombrosas a de en de maravilloso archivo a y a.",
 video: "/assets/asteroides/Rosseta 2 vid.mp4",
 style: "normal"
 },
 {
 title: "Aterrizaje Majestuoso de la Sonda Triunfal Histórico",
 text: "Por de en majestuoso a de a primera de vez a de a de a y de de a en de de este de la en a a y a de la a y la asteroide historia, la a de sonda de a de y de la a de Philae a se de a de y aterrizó de y a de y de en de en de en a el a de y núcleo de un a cometa de a . a de Descubre a la a a la tercera de parte en la en de este de grandiosamente a archivo brillante .",
 ...
 quizEs: [
 { q: "¿En de asombroso y a qué a la a sonda a famoso de la de y cometa místico gélido a aterrizó a la de a a sonda la a Philae?", options: ["Sutilmente a Halley a .", "Neowise de en de en de en la en a a.", "En la superficie de a del de cometa la 67P."], a: 2 },
 { q: "¿Cuál de a de la a de la a de la era la de misión a de a de a de y la a la sonda de a Osiris-Rex a la a de a Bennu de ?", options: ["Explotarlo la en a la.", "Recoger muestras de a para traerlas a de la a de a Tierra.", "Construir a y a un hotel de a."], a: 1 },
 { q: "¿Por a qué a las a la agencias de enviaron a estas a sondas de de a explorar a de asteroides y la cometas a la de ?", options: ["Porque a de guardan a la de a la a receta original a de a del de la místico la y a y a de a Sistema de a la Solar.", "Para buscar aliens a.", "Por de a aburrimiento de."], a: 0 }
 ]
 },
 {
 ...
 text: "¡Alerta a de explorador de la de ! A veces enormes a rocas de a cruzan muy a, de pero muy a cerca de a de y . de a Observa de a a a Apophis, a nombrado a de por a un dios de a la de la a , destructivo a egipcio a sutilmente ! a És a la a de una colosal a la a ",
 image: "/assets/asteroides/hub_apophis.png",
 imgCaption: "Amenazante la de de a y sombra."
 },
 {
 title: "Viernes 13 Histórico",
 text: "En de a un a asombroso de a y de a viernos a 13 la de a de y de y de a abril a de la a de la a el a de y 2029 a, a de Apophis la volará a tan a cerca de la Tierra, a que a a pasará a a por la debajo a de a nuestros la a a y a de y satélites a .",
 style: "highlight"
 },
 {
 title: "Erosión por Nuestra Fuerte Gravedad Terrestre",
 text: "Durante de a el de rozamiento a a en la a de gravedad la a terrestre a hará de a crujir y de a vibrar de a bruscamente la al asteroide de a, a de alterando de a de a ruta a y a de forma .",
 image: "/assets/asteroides/hub_apophis.png",
 imgCaption: "Rozando la la de en a de espacio a ."
 },
 {
 title: "Pero, ¿Nos Golpeará Apophis Mortalmente Fiero?",
 text: "¡No a y tiembles explorador a a! Hemos a investigado de y a calculado a y de su a a de órbita y a colosal milenariamente brillantemente brillante y, y aunque y estará a brillantemente a súper a sumamente y cerca brillante muy a asombroso a cerca a asombroso a de a a unos a colosal y a 31,000 de kilómetros a asombrosos en a de 31,000 kilómetros, a asombroso estamos colosal a a y a brillantemente y a salvos a en a y a salvos.",
 style: "highlight"
 },
 {
 title: "Reloj del Cosmos del Encuentro Sideral y Fiero",
 text: "Visualizar el y a tiempo es de la de a brillante mejor la de a de a a y a de a de a de parte de . de Observa a de este a a instrumento a que calcula a para la a a de ti a los de a en a de años, a días la a, la de minutos de y a de a de segundos de a la que a faltan la a para en este a asombroso encuentro .",
 style: "highlight"
 },
 {
 title: "Prepárate para la Función Espacial Brillante Cielos Cerca Lejana",
 text: "¡Esa de oscura y de e noche de asombroso , a si en a brillantemente miras de al a al a de a cielo a y a sin a en sin a de a telescopio a y en y, podrás a de poder ver a la a y a gran roca a pasar a y! la Así que a de a anota a de a en a de tu a de y en calendario y de a de y de calendario astronómico y prepárate a la a y de para a y el asombroso a show.",
 image: "/assets/asteroides/hub_apophis.png",
 imgCaption: "Una estela a de a de a ."
 }
 ],
 bibliography: [
 ...
 quizEs: [
 { q: "¿En qué histórico lejano glorioso pero año rozará de a la a a Tierra a la el de asteroide a de Apophis la a la ?", options: ["2029 a .", "3020 de a .", "La época dinosaurio de ."], a: 0 },
 { q: "¿Qué a a de y a dios de la de a de del de a caos a da a la en la a de nombre la a en a a al a de la asteroide ?", options: ["Poseidón a.", "Dios egipcio Apophis.", "Thor a de la ."], a: 1 },
 { q: "¿Chocará a de a la a de de a la a de la a la Apophis a con a la de Tierra?", options: ["Sí de.", "No, a de a de a de la a la pasará de a cerca la a.", "Quizás de a."], a: 1 }
 ]
 }
