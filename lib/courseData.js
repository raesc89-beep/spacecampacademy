export const COURSE_DATA = [
 ...
 image: "/assets/anim_gatos_felicette_launch_1776352929519.png",
 ...
 image: "/assets/anim_gatos_electrodes_brain_1776352946680.png",
 ...
 image: "/assets/anim_gatos_felicette_return_1776352963906.png",
 ...
 image: "/assets/anim_gatos_felicette_monument_1776352978129.png",
 ...
 ,
  {
    ...
    titleEn: 'Asteroids and Comets', titleEs: 'Asteroides y Cometas',
    badge: 'Rock Hopper', badgeEs: 'Saltador de Rocas',
    color: '#9CA3AF',
    contentEs: {
      sections: [
        {
          title: "¿Qué son? Y cuáles son sus principales diferencias",
        ...
        },
        {
          ...
          imgCaption: "El gran anillo de rocas flotantes."
        }
      ],
      bibliography: ["NASA Asteroid Facts."]
    },
    quizEs: [
      { q: "¿En qué región se encuentra la mayoría de los asteroides?", options: ["Entre la Tierra y Marte", "En el cinturón entre Marte y Júpiter", "Cerca de Mercurio"], a: 1 },
      { q: "¿De qué están compuestos principalmente los asteroides?", options: ["Agua pura", "Solo gas", "Roca, polvo y gases"], a: 2 },
      { q: "¿Qué es un meteoro?", options: ["Un planeta pequeño", "Una estrella fugaz gigante", "El resultado de un meteoroide ardiendo en la atmósfera"], a: 2 }
    ]
  },
  {
    ...
    contentEs: {
      sections: [
        ...
        {
          title: "Chicxulub y la Extinción",
          text: "Algunos impactos no son sutiles. Hace 66 millones de años, un monstruoso meteorito de unos 10 kilómetros de diámetro, conocido como el impactador Chicxulub, golpeó lo que hoy es la Península de Yucatán en México. El apocalíptico impacto desató tsunamis gigantes, incendios globales y un invierno cataclísmico que provocó la extinción masiva del 75% de las especies de la Tierra, acabando definitivamente con el reinado de los grandes dinosaurios y abriendo paso para el futuro de los mamíferos.",
          video: "/assets/asteroides/Caida Metorito.mp4",
          style: "normal"
        }
      ],
      bibliography: ["National Geographic: Ann Hodges."]
    },
    quizEs: [
      { q: "¿Cómo se llama un fragmento que sobrevive y logra impactar la superficie terrestre?", options: ["Meteoroide", "Meteorito", "Planetesimal"], a: 1 },
      { q: "¿Quién fue la persona que hizo historia al ser impactada por un meteorito?", options: ["Isabel Anderson", "Ann Hodges", "Amelia Earhart"], a: 1 },
      { q: "¿Cuál es el nombre del impacto en México que extinguió a los dinosaurios?", options: ["Krakatoa", "Tunguska", "Chicxulub"], a: 2 }
    ]
  },
  {
    id: 'asteroides_cometas', order: 23,
    titleEn: 'Comets', titleEs: 'Cometas',
    badge: 'Ice Voyager', badgeEs: 'Viajero de Hielo',
    color: '#60A5FA',
    contentEs: {
      sections: [
        {
          title: "¿Qué es un cometa?",
          text: "A diferencia de la roca seca de los asteroides, un cometa está compuesto de hielo cósmico congelado, gases letales oscuros y mucho polvo estelar. A medida que viajan desde las zonas y límites fríos de la constelación y se acercan dramáticamente al Sol ardiente, parte del hielo profundo comienza a evaporarse furiosamente, dejando tras de sí una colosal y brillante cola gaseosa llamada 'coma'. Esto los distingue inconfundiblemente de los asteroides y de las lluvias de meteoritos comunes.",
          video: "/assets/asteroides/Cometa Neowise.mp4",
          style: "highlight"
        }
      ],
      bibliography: ["NASA Comets Overview."]
    },
    quizEs: [
      { q: "¿De qué están hechos principalmente los cometas?", options: ["Solamente polvo", "Metal denso", "Hielo, agua congelada, polvo y rocas"], a: 2 },
      { q: "¿Cómo se llama la nube o cola brillante que se forma cuando un cometa se acerca al Sol?", options: ["Anillo", "Coma", "Aura"], a: 1 },
      { q: "¿Cuál es la diferencia principal entre un cometa y un asteroide seco?", options: ["Tienen hielo que se evapora creando una cola", "Giran más rápido", "Son perfectamente esféricos"], a: 0 }
    ]
  },
  {
    id: 'asteroides_sondas', order: 24,
    titleEn: 'Space Probes', titleEs: 'Sondas',
    badge: 'Deep Explorer', badgeEs: 'Explorador Profundo',
    color: '#34D399',
    contentEs: {
      sections: [
        {
        ...
        {
           title: "Módulo en Descenso",
           text: "Observando el accidentado terreno de 67P.",
           video: "/assets/asteroides/Rosseta 2 vid.mp4",
           style: "normal"
        },
        {
           title: "El Toque de Philae (Parte 1)",
           text: "Impacto en gravedad cero.",
           video: "/assets/asteroides/Rosseta 3vid.mp4",
           style: "normal"
        },
        {
           title: "Transmisión Final (Parte 2)",
           text: "Superficie de un cometa gélido confirmada.",
           video: "/assets/asteroides/Rosset vid 3 parte 2.mp4",
           style: "normal"
        }
      ],
      bibliography: ["ESA Rosetta Cometary Mission.", "NASA Osiris-Rex Asteroid Sample Return."]
    },
    quizEs: [
      { q: "¿En qué inestable cometa aterrizó el primer módulo Philae de Rosetta?", options: ["Cometa Halley.", "Cometa Neowise.", "Cometa 67P/Churyumov-Gerasimenko."], a: 2 },
      { q: "¿Cuál fue la misión central de la sonda Osiris-Rex al acercarse a Bennu?", options: ["Destruirlo con láser", "Recoger una muestra estelar y traerla de retorno a la Tierra", "Instalar paneles solares extraterrestres"], a: 1 },
      { q: "¿Qué complicó monumentalmente el aterrizaje y captura del cometa?", options: ["La falta de gravedad y los chorros de hielo desestabilizantes", "El campo magnético", "La temperatura del magma"], a: 0 }
    ]
  },
  {
      ...
      sections: [
        {
          ...
          text: "¡Alerta explorador! A veces enormes bloques rocosos cruzan muy cerca de nuestro hogar. Observa al asteroide 99942 Apophis, terroríficamente nombrado así en honor a una mitológica serpiente y dios del caos originario del Antiguo Egipto.",
          image: "/assets/hub_apophis_vector.png",
          imgCaption: "Apophis, la letal y temible sombra rocosa del espacio cercano."
        },
        {
          title: "Viernes 13 (2029)",
          text: "Para asombro mundial, durante el viernes 13 de abril del legendario año 2029, Apophis realizará una increíble aproximación a la Tierra, volando tan bajo que cruzará el plano orbital de parte de nuestros propios satélites de comunicaciones geosíncronos a menos de 32,000 kilómetros. Será un gran espectáculo a simple vista.",
          style: "highlight"
        },
        {
          title: "La Fuerza Gravitacional",
          text: "Pero la Tierra también tiene un impacto sobre la roca. La enorme presión gravitacional de nuestro gran planeta literalmente morderá y retorcerá estrepitosamente a Apophis. Durante esta aproximación épica ocurrirán los llamados 'deslizamientos' o avalanchas geológicas sobre la superficie de este frío asteroide alterando severamente la forma de la roca para siempre.",
          style: "normal"
        },
        {
          title: "¡No Entres en Pánico! Cálculo Milimétrico",
          text: "Múltiples centros astrofísicos y laboratorios de todo el mundo lograron calcular y recalcular las órbitas usando alta precisión de rastreo por radar. Quedó completamente confirmada la descalificación de una colisión directa catastrófica para la Tierra durante su paso en el 2029. Estaremos grandiosamente a salvo disfrutando del gran espectáculo lejano.",
          style: "highlight"
        }
      ],
      bibliography: ["NASA Eyes on Asteroids: Apophis Approach (2029)."]
    },
    quizEs: [
      { q: "¿En qué año se aproximará brutalmente y sin peligro el asteroide Apophis a la Tierra?", options: ["2029", "2500", "En el año 3000"], a: 0 },
      { q: "¿Qué sucederá con Apophis al pasar tan cerca de nuestro planeta?", options: ["Comenzará a emitir luz biológica", "La gravedad de la Tierra creará avalanchas superficiales que la van a sacudir y alterar su forma", "Comenzará a nevar"], a: 1 },
      { q: "¿Es necesario preocuparnos por una colisión apocalíptica?", options: ["Sí, tenemos que prepararnos", "No, los cálculos de radar confirman que nos librará limpiamente", "Aún no se ha inventado una forma de averiguarlo"], a: 1 }
    ]
  }
];
