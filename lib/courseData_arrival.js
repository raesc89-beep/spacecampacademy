...
export const ARRIVAL_COURSE_DATA = [
  {
    ...
    badgeIcon: '/assets/ciencia_arrival/arrival_m1.png',
    color: '#708090',
      ...
      sections: [
        {
          ...
          image: '/assets/ciencia_arrival/arrival_m1.png',
...

  {
    ...
    badgeIcon: '/assets/ciencia_arrival/arrival_m2.png',
    color: '#4682B4',
      ...
      sections: [
        {
          ...
          image: '/assets/ciencia_arrival/arrival_m2.png',
...

  {
    ...
    badgeIcon: '/assets/ciencia_arrival/arrival_m3.png',
    color: '#9B59B6',
      ...
      sections: [
        {
          ...
          image: '/assets/ciencia_arrival/arrival_m3.png',
...

  {
    ...
    badgeIcon: '/assets/ciencia_arrival/arrival_m4.png',
    color: '#E74C3C',
      ...
      sections: [
        {
          ...
          image: '/assets/ciencia_arrival/arrival_m4.png',
...

  {
    ...
    badgeIcon: '/assets/ciencia_arrival/arrival_m5.png',
    color: '#FFD700',
      ...
      sections: [
        {
          ...
          image: '/assets/ciencia_arrival/arrival_m5.png',
...

  {
    ...
    badgeIcon: '/assets/ciencia_arrival/arrival_m6.png',
    color: '#2ECC71',
      ...
      sections: [
        {
          ...
          image: '/assets/ciencia_arrival/arrival_m6.png',
