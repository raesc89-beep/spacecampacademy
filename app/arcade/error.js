  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <h1 style={styles.title}>¡Fallo en el simulador!</h1>
        <p style={styles.subtitle}>
          El simulador de vuelo encontró un error inesperado. Reiniciando
        ...
        <div style={styles.buttonGroup}>
          ...
          <a href="/hub/arcade" style={styles.secondaryButton}>
            🕹️ Volver al arcade
          </a>
        </div>
      </div>
