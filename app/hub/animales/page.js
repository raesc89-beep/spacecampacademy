...
export default function AnimalesHub() {
  ...
  const orbitalData = {
    animales_intro: { left: '20%', top: '50%', size: 'clamp(80px, 9vw, 120px)', img: '/assets/animales/vector_intro.png' },
    animales_mamiferos: { left: '35%', top: '30%', size: 'clamp(90px, 10vw, 140px)', img: '/assets/animales/vector_mamiferos.png' },
    animales_albert_ham: { left: '55%', top: '70%', size: 'clamp(100px, 11vw, 150px)', img: '/assets/animales/vector_albert_ham.png' },
    animales_laika: { left: '75%', top: '25%', size: 'clamp(110px, 12vw, 160px)', img: '/assets/animales/vector_laika.png' },
    animales_gatos: { left: '90%', top: '60%', size: 'clamp(80px, 9vw, 130px)', img: '/assets/animales/vector_gatos.png' }
  };
