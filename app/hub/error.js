...
export default function Error({ error, reset }) {
  useEffect(() => {
    console.error('Hub error boundary caught:', error);
  }, [error]);
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        ...
        <h1 style={styles.title}>¡Error en la estación espacial!</h1>
        <p style={styles.subtitle}>
          Se detectó una anomalía en los sistemas de la estación. Nuestros
          ingenieros están revisando los circuitos.
        </p>
