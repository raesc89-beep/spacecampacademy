      ...
      <main style={{ flex: 1, position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        ...
        <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: '1200px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3rem' }}>
          ...
          >
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '1rem', marginTop: '1.5rem', justifyContent: 'center' }}>
              {/* Polvo Estelar badge */}
              <div style={{ display: 'inline-flex', alignItems: 'center', gap: '1rem', background: 'rgba(0,0,0,0.6)', padding: '0.5rem 1.5rem', borderRadius: '30px', border: '1px solid rgba(255,215,0,0.3)', backdropFilter: 'blur(10px)' }}>
              ...
              {/* Cuarto del Astronauta — prominent profile button */}
              <Link href="/profile" style={{ textDecoration: 'none' }}>
                <motion.div
                  whileHover={{ scale: 1.08, boxShadow: '0 0 35px rgba(0,206,209,0.5), inset 0 0 20px rgba(0,206,209,0.15)' }}
                  whileTap={{ scale: 0.95 }}
                  style={{
                    display: 'inline-flex', alignItems: 'center', gap: '0.8rem',
                    background: 'linear-gradient(135deg, rgba(0,206,209,0.15), rgba(153,51,255,0.1))',
                    backdropFilter: 'blur(12px)',
                    padding: '0.6rem 1.5rem', borderRadius: '30px',
                    border: '1px solid rgba(0,206,209,0.5)',
                    boxShadow: '0 0 20px rgba(0,206,209,0.2), inset 0 0 10px rgba(0,206,209,0.08)',
                ...
                >
                  ...
                  <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <motion.div
                      ...
                      style={{ position: 'absolute', width: 36, height: 36, borderRadius: '50%', border: '1px solid rgba(0,206,209,0.5)' }}
                    />
                    <UserCircle size={22} color="#00CED1" style={{ filter: 'drop-shadow(0 0 6px #00CED1)' }} />
                  </div>
                  <span style={{ color: '#fff', fontWeight: 700, fontSize: '0.95rem', letterSpacing: '1px', textTransform: 'uppercase' }}>Cuarto del Astronauta</span>
